...
namespace WBWord
{
	...
	public class NewStep4 : TSWizards.BaseStep
	{
		...
		/// <summary>Árbol de secciones para seleccionar donde sera almacenado el contenido</summary>
		/// <value>Árbol de secciones para seleccionar donde sera almacenado el contenido</value>
		...
		TreeManager tm=null;
		/// <summary>
		/// Construye una forma (página de asistente)
		/// </summary>
		...
		public NewStep4(System.Windows.Forms.Button next)
		{
			...
			try
			{
				if(treeView1==null)
				{
					MessageBox.Show("tree nulo");
					return;
				}
				if(next==null)
				{
					MessageBox.Show("boton nulo");
					return;
				}
				...
				tm=new TreeManager(this.treeView1,next,CWebBuilder.user);
			}
			catch(Exception e)
			{				
