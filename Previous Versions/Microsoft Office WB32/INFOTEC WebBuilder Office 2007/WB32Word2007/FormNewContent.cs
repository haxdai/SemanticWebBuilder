...
namespace WBWord
{
	...
	public class FrmNewContent : TSWizards.BaseWizard
	{
		...
		/// <summary>
		/// Crea una forma asistente para publicación de contenido
		/// </summary>
		/// <param name="parametros">Parametros para alta</param>
		...
		private void InitializeComponent()
		{
			...
			this.LoadSteps += new System.EventHandler(this.FormNewContent_LoadSteps);
			this.ResumeLayout(false);

		}
		#endregion

		private void FormNewContent_LoadSteps(object sender, System.EventArgs e)
		{			
			...
			this.Steps.Add("Step8",new NewStep8());
