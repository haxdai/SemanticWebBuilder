...
namespace WBWord
{
	...
	public class OpenStep6 : TSWizards.BaseStep
	{
		...
		/// </summary>
		/// <param name="driveLetter">letra del drive</param>
		/// <returns></returns>
		...
		/// <summary>Crea el control que muestra el avance de descarga de contenido</summary>
		public OpenStep6()
		{
		...
		private void OpenStep6_ShowStep(object sender, TSWizards.ShowStepEventArgs e)
		{
			...
			try
			{
                Word.DocumentClass book = null;
				if(CWebBuilder.app.Documents.Count==0)
				{
					object objmissing=Type.Missing;
					object objfalse=false;

                    book = (Word.DocumentClass)CWebBuilder.app.Documents.Add(ref objmissing, ref objmissing, ref objmissing, ref objmissing);
					prefix=book.WebOptions.FolderSuffix;
					book.Close(ref objfalse,ref objmissing,ref objmissing);
				}
				else
				{
					object index=1;
                    book = (Word.DocumentClass)CWebBuilder.app.Documents.get_Item(ref index);
					prefix=book.WebOptions.FolderSuffix;
				}
			}
			catch{}
				...
				if(treedir.SelectedNode!=null && step2.treeView1.SelectedNode!=null && step2.treeView1.SelectedNode is WBNode)
				{
					...
					foreach(IParameter presult in FrmOpenContent.resultados)
					{
						if(presult.Name.Equals("content"))
						{
							...
							foreach(Word.DocumentClass docopen in CWebBuilder.app.Documents)
							{
							...
							foreach(IParameter presultiamges in FrmOpenContent.resultados)
							{
								...
								{	
									if(idcont!=null && version!=null)
									{
										...
										CDownLoadContent cdown=new CDownLoadContent(fimagen,idtopicmap,idcont,version,CWebBuilder.user,resType);
							...
							ParameterCollection resultados=CWebBuilder.resultados;
							...
							if(fword.Exists)
							{
								...
								if(Appversion>=11)
                                    dochtml = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref filename, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing);										
								else
                                    dochtml = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref filename, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing);										
							...
							{								
								if(Appversion>=11)
                                    dochtml = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref strpathHtml, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref objformathtml, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing);		
								else
                                    dochtml = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref strpathHtml, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref objformathtml, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing);	
							}
							...
							if(Appversion>=11)
                                docopenwb = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref strpathDoc, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing);
							else
                                docopenwb = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref strpathDoc, ref missing, ref missing, ref objfalse, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing);
							
							// guarda las propedades
							


							CWebBuilder.resultados=resultados;
							...
							try
							{
								foreach(Word.InlineShape shape in docopenwb.InlineShapes)
								{
									try
									{
							...
							if(Appversion>=11)							
							{
								...
								try
								{
                                    docopenwb = (Word.DocumentClass)CWebBuilder.app.Documents.Open(ref strpathDoc, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing, ref missing);
								...
								foreach(Word.Document doc in CWebBuilder.app.Documents)
								{
			...
			{
				Trace.WriteLine(undefe.Message);
				Trace.Indent();				
				Trace.WriteLine(undefe.StackTrace);
				Trace.Unindent();
				Trace.WriteLine("");
				Trace.Flush();
				this.Cursor=Cursors.Default;
				FrmOpenContent.resultados.Add(new Parameter("error",undefe.Message));   
				MessageBox.Show(this,resources.GetString("FrmOpen3.msg2") +" [ "+ undefe.Message +" ]\r\n"+"stackTrace:"+undefe.StackTrace+"\r\n",this.Text,MessageBoxButtons.OK ,MessageBoxIcon.Error );				
				this.Wizard.MoveTo(step);
				return;
			}
...
//										}
		...
		private String Parsea(String html,String pathdoc,bool showWarning,FileInfo fdoc)
		{
			...
			{
				MessageBox.Show(this,resources.GetString("FrmOpen3.msg1"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Warning);  
			}
			return html;
		}
