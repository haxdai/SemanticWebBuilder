...
namespace WBOffice3
{
	...
	public class FrmPeriodicidad : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.TextBox yyear2;
		...
		private System.Windows.Forms.TextBox mmonth2;
		...
		private System.Windows.Forms.TextBox mmonth;
		...
		private System.Windows.Forms.TextBox yyear;
		private System.Windows.Forms.TextBox yday;
		...
		public FrmPeriodicidad(ListViewItem item,CUserAdmin user,ListView list)
		{
			//
			...
			String xmlconf=((XmlElement)item.Tag).OuterXml;
			if(xmlconf!=null)
			{
				if(!(xmlconf.Equals("") || xmlconf.Equals("null")))
				{
					...
					{
						this.textBox1.Text=docc.GetElementsByTagName("title")[0].InnerText;
					}
			...
			#region Cargado de forma
					...
					if(siteminterval[0]!=null)
					{
						...
						this.dateTimePicker1.Value=System.Convert.ToDateTime(dia+"/"+mes+"/"+ano);
					}				
					...
					if(siteminterval[1]!=null)
					{
						...
						this.dateTimePicker2.Value=System.Convert.ToDateTime(dia+"/"+mes+"/"+ano);
					}
					else
					{
		...
		private void InitializeComponent()
		{
            ...
            this.yyear = new System.Windows.Forms.TextBox();
            this.yday = new System.Windows.Forms.TextBox();
            ...
            this.yyear2 = new System.Windows.Forms.TextBox();
            ...
            this.yyear.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.yyear_KeyPress);
            // 
            // yday
            // 
            resources.ApplyResources(this.yday, "yday");
            this.yday.Name = "yday";
            this.yday.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.yday_KeyPress);
            // 
            // periodyear1
            // 
            ...
            this.yyear2.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.yyear2_KeyPress);
            // 
            // ymonth2
            // 
            ...
            this.mmonth.TextChanged += new System.EventHandler(this.mmonth_TextChanged);
            this.mmonth.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.mmonth_KeyPress);
            // 
            // label10
            // 
            ...
            this.mday.Name = "mday";
            this.mday.TextChanged += new System.EventHandler(this.mday_TextChanged);
            this.mday.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.mday_KeyPress);
            // 
            // periodmont1
            // 
            ...
            this.mmonth2.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.mmonth2_KeyPress);
            // 
            // label14
            // 
		...
		{
			XmlElement xml=(XmlElement)item.Tag;
			if(xml.OwnerDocument.GetElementsByTagName("Resource").Count>0)
			{			
				xml=(XmlElement)xml.OwnerDocument.GetElementsByTagName("Resource")[0];
				if(xml.GetAttribute("new")=="true")
				{
					item.Remove();
				}
			}
		...
		private void buttonAceptar_Click(object sender, System.EventArgs e)
		{
			...
			if(this.textBox1.Text.Trim()=="")
			{
				...
				MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msgtitle"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
				return;
			}
			foreach(ListViewItem itemlist in this.list.Items)
			{
				...
				{
					this.Cursor=Cursors.Default; 
					MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msgtitlerep"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
					return;
				}
			}
			...
			{
				this.Cursor=Cursors.Default; 
				MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msgtime"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
				return;
			}
			if(periodicidad.Checked)
			{
				if(periodweek.Checked)
				{
					...
					{
						this.Cursor=Cursors.Default; 
						MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg1"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
						return;
					}
				}
				if(periodmonth.Checked)
				{
					if(periodmont2.Checked)
					{
						...
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg2"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						if(mmonth2.Text=="")
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg3"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						try
						{
							int imes=Int32.Parse(mmonth2.Text);
							if(imes==0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg4"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return ;
							}							
						}
						catch(Exception ue)
					...
					else
					{
						...
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg5"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						if(mmonth.Text=="")
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg6"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						try
						{
							int idia=Int32.Parse(mday.Text);
							if(idia>31)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg7"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return ;
							}
							if(idia<=0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg8"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return ;
							}
						}
						catch(Exception ue)
						...
						try
						{
							int imes=Int32.Parse(mmonth.Text);
							if(imes==0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg9"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return;
							}							
						}
						catch(Exception ue)
				...
				if(periodyear.Checked)
				{
					if(periodyear2.Checked)
					{
						...
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg10"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return;
						}
						if(yyear2.Text=="")
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg11"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return;
						}
						try
						{
							int imes=Int32.Parse(yyear2.Text);
							if(imes==0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg12"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return;
							}							
						}
						catch(Exception ue)
					...
					else
					{
						...
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg13"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						if(yyear.Text=="")
						{
							this.Cursor=Cursors.Default; 
							MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg14"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
							return ;
						}
						try
						{
							int idia=Int32.Parse(yday.Text);
							if(idia>31)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg15"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return ;
							}
							if(idia<=0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg16"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return ;
							}
						}
						catch(Exception ue)
						...
						try
						{
							int imes=Int32.Parse(yyear.Text);
							if(imes==0)
							{
								this.Cursor=Cursors.Default; 
								MessageBox.Show(this,resources.GetString("FrmPeriodicidad.msg17"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
								return;
							}							
						}
						catch(Exception ue)
			...
			if(this.dateTimePicker1.Enabled && this.dateTimePicker2.Enabled)
			{
				if(this.dateTimePicker1.Value>this.dateTimePicker2.Value)
				{
					this.Cursor=Cursors.Default; 
					MessageBox.Show(resources.GetString("FrmPeriodicidad.msg33"),this.Text,MessageBoxButtons.OK,MessageBoxIcon.Error);  
					return;					
				}
			}
			#endregion			
			...
			title.InnerText=this.textBox1.Text;
			...
			elem.InnerText="/"+this.dateTimePicker1.Value.Month+"/"+this.dateTimePicker1.Value.Day+"/"+this.dateTimePicker1.Value.Year; 		
			interval.AppendChild(elem);
			if(this.endselect.Checked)
			{
				elem=doc.CreateElement("enddate");
				elem.InnerText="/"+this.dateTimePicker2.Value.Month+"/"+this.dateTimePicker2.Value.Day+"/"+this.dateTimePicker2.Value.Year; 		
				interval.AppendChild(elem);
			}
			...
			{
				parametros.Add(new Parameter("rule",this.listView3.Items[i].Text));
			}*/
