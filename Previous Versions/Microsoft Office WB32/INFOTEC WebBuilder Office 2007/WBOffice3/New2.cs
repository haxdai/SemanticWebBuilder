...
namespace WBOffice3
{
	/// <summary>Muestra el árbol de secciones y sitios a los que tiene permisos el usuario</summary>
	public class New2 : TSWizards.BaseInteriorStep
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CLibrary));
		/// <summary>
		/// Arbol de secciones a las que tiene permiso el usuario, también incluye
		/// sitios
		/// </summary>
		...
		public New2(Button next)
		{
			...
			tm=new TreeManager(this.treeView1,next,FrmNewSection.user);
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(New2));
			...
			this.ShowStep += new TSWizards.ShowStepEventHandler(this.New2_ShowStep);
		...
		private void New2_ValidateStep(object sender, System.ComponentModel.CancelEventArgs e)
		{			
			this.Cursor=Cursors.WaitCursor;										
			TreeNode root=this.treeView1.SelectedNode;
			/*if(!FrmNewSection.user.GetPermiso(root,PermisoType.CrearTopicos))
			{
		...
		private void New2_ShowStep(object sender, TSWizards.ShowStepEventArgs e)
		{
