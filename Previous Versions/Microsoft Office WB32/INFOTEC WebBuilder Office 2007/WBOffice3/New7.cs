...
namespace WBOffice3
{
	/// <summary>Control que termina el asistente</summary>
	public class New7 :  TSWizards.BaseExteriorStep
	{
		/// <summary> 
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(New7));
			this.SuspendLayout();
			// 
			// Description
			// 
			...
			this.ShowStep += new TSWizards.ShowStepEventHandler(this.New7_ShowStep);
			this.ResumeLayout(false);

		}
		#endregion

		private void New7_ShowStep(object sender, TSWizards.ShowStepEventArgs e)
		{
