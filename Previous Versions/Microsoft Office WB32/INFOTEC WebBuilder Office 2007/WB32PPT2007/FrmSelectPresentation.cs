...
{
	/// <summary>Forma que permite indicar que tipo de publicación se realizará.</summary>
	public class FrmSelectPresentation : TSWizards.BaseWizard
	{
		private System.ComponentModel.IContainer components = null;
		/// <summary>
		/// Indica si la selección de publicación se realizará compatible con Microsoft
		/// Explorer
		/// </summary>
