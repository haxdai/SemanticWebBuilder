...
namespace WBPowerPoint
{
	...
	public class FrmDocumentosXAutorizar : System.Windows.Forms.Form
	{
		...
		public FrmDocumentosXAutorizar(CUserAdmin user,PowerPoint.Application app)
		{
			//
		...
		private void listView1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
				...
				{				
					...
					object missing=Type.Missing;
					FrmPreview frm=new FrmPreview(topicmap,topicid,idcont,lastversion,CPowerPoint.user);
		...
		private void buttonInfo_Click(object sender, System.EventArgs e)
		{
			if(this.listView1.SelectedItems.Count>0)
			{
				...
				String topicmap=item.TopicMap;
				String topicid=item.Topic;			
				FrmProp prop=new FrmProp(topicmap,topicid,item.ID,this.user,CPowerPoint.TYPE);
		...
		private void buttonOpen_Click(object sender, System.EventArgs e)
		{
			...
			{				
				...
				{			
					...
					OpenPPTDocument(app,idtopicmap,idtopic,idcontent,this.user,new DirectoryInfo(treedir.FolderName));
					return;
				}
			}
		...
		/// <summary>
		/// Abre un contenido de PPT
		/// </summary>
		/// <param name="app">Aplicación PPT</param>
		/// <param name="idtopicmap">Sitio</param>
		/// <param name="idtopic">Sección</param>
		/// <param name="idcontent">Contenido</param>
		/// <param name="user">Usuario</param>
		/// <param name="dinfo">Directorio de almacenamiento</param>
		public static void OpenPPTDocument(PowerPoint.Application app,String idtopicmap,String idtopic,String idcontent,CUserAdmin user,System.IO.DirectoryInfo dinfo)
		{
			...
			foreach(WBOffice3.IParameter presult in resultados)
			{
				if(presult.Name.Equals("content"))
				{
					...
					foreach(PowerPoint.Presentation docopen in app.Presentations)
					{
					...
					if(fppt.Exists)
					{
                        PowerPoint.Presentation dochtml = app.Presentations.Open((string)fppt.FullName, Office.MsoTriState.msoFalse, Office.MsoTriState.msoFalse, Office.MsoTriState.msoFalse);
					...
					{
                        PowerPoint.Presentation dochtml = app.Presentations.Open((string)strpathHtml, Office.MsoTriState.msoFalse, Office.MsoTriState.msoFalse, Office.MsoTriState.msoFalse);
                        dochtml.SaveAs((string)strpathDoc, PowerPoint.PpSaveAsFileType.ppSaveAsDefault, Office.MsoTriState.msoTrue);
						dochtml.Close();
					}
                    PowerPoint.Presentation docopenwb = app.Presentations.Open((string)strpathDoc, Office.MsoTriState.msoFalse, Office.MsoTriState.msoFalse, Office.MsoTriState.msoTrue);
		...
		private static String Parsea(String html,String pathdoc,bool showWarning,FileInfo fdoc)
		{
			...
			{
				MessageBox.Show(resources.GetString("FrmOpen3.msg1ppt"),resources.GetString("Global.title"),MessageBoxButtons.OK,MessageBoxIcon.Warning);  
			}
			return html;
		}
