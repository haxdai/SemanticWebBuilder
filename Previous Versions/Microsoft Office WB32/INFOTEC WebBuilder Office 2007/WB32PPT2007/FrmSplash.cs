	...
	public class FrmSplash : System.Windows.Forms.Form
	{
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				CPowerPoint.user.ServerProxy=this.proxyserver;
				CPowerPoint.user.PortServerProxy=Int32.Parse(this.portserverproxy); 
				s.login();	
				if(!s.IsError) 
				{					
					...
					/*try
					{
						CPowerPoint.Connect.mLogout.Enabled=true;
						CPowerPoint.Connect.mLogin.Enabled=false;
					}
					catch{}*/
