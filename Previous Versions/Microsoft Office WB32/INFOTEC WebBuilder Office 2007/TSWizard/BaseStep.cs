...
namespace TSWizards
{
	...
	public class BaseStep : System.Windows.Forms.UserControl
	{
		...
		/// <summary>
		/// Tamaño por defecto de la pagina exterior
		/// </summary>
		protected static Size DefaultExteriorPageSize = new Size(324, 313);
		/// <summary>
		/// Tamaño por defecto de la pagina interior de un asistente
		/// </summary>
		...
		/// <summary>
		/// Descripción que presentara la forma de asistente
		/// </summary>
		...
		/// <summary>
		/// Descripción de la página de asistente
		/// </summary>
		[Localizable(true)]
		...
		/// <summary>
		/// Propiedad que determina cuál página es la anterior a la actual
		/// </summary>
		[Browsable(true)]
		[Category("Wizard Step")]
		...
		/// <summary>
		/// Propiedad que determina cuál página es la siguiente a la actual
		/// </summary>
		[Browsable(true)]
		[Category("Wizard Step")]
	...
	/// </summary>
		...
		/// <summary>
		/// Propiedad que indica si la página es la página final del sistente
		/// </summary>
		[Browsable(true)]
		[Category("Wizard Step")]
		...
		/// <summary>
		/// Evento de cambio de página siguiente
		/// </summary>
		[Browsable(true)]
		[Category("Wizard Step")]
		...
		/// <summary>
		/// Evento de cambio de descripción en un apágina del asistente
		/// </summary>
		[Browsable(true)]
		[Category("Wizard Step")]
		...
		/// <summary>
		/// Manejador de eventos cuando se cambia una descripción de un asistente
		/// </summary>
		/// <param name="e"></param>
