...
namespace WBExcel
{
    ...
    {
        CUserAdmin user;
        WBExcel.Connect connect = new WBExcel.Connect();
        private Office.IRibbonUI ribbonUI;
        Excel.Application applicationObject;
        System.Resources.ResourceManager resources = new System.Resources.ResourceManager("WB32Excel2007.ResourceConfig", Assembly.GetExecutingAssembly());
        public Ribbon1(Excel.Application applicationObject)
        {
        ...
        {
            return GetResourceText("WB32Excel2007.Ribbon1.xml");
        }
        ...
        {
            if (this.applicationObject.Workbooks.Count == 0)
            {
                return false;
            }
            return true;
        ...
        public bool isWBDocument(Office.IRibbonControl control)
        {
            try
            {
                ...
                Excel.Workbook workbook = this.applicationObject.ActiveWorkbook;
                if (workbook == null)
                {
                    return false;
                }
                Microsoft.Office.Core.DocumentProperties props = (Microsoft.Office.Core.DocumentProperties)workbook.CustomDocumentProperties;
        ...
        public void onBitacora(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.Bitacora(this.applicationObject, user);
        ...
        public void onInfo(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.ResumenArchivos(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onShowPagina(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.ShowPagina();
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onShowManual(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.ShowManual();
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onPreview(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.Preview(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onMuestraFlujo(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.MuestraFlujo(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onDeleteAsociation(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.deleteAsociation();
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onDelete(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.Delete(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onChangePassword(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.ChangePassword(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onCreateTopic(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.CreateTopic(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onCreateRule(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.CreateRule(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void Onprop(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.Properties(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onSave(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.New(this.applicationObject, user);
                this.InvalidateControls();
        ...
        public void onOpen(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.Connect.wbe.Open(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void onClose(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.CExcel.user = WBExcel.Connect.wbe.Logout(this.applicationObject, user);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
        ...
        public void OnInit(Office.IRibbonControl control)
        {
            try
            {
                ...
                WBExcel.CExcel.user = WBExcel.Connect.wbe.Login(this.applicationObject);
                this.InvalidateControls();
            }
            catch (Exception ue)
            {
