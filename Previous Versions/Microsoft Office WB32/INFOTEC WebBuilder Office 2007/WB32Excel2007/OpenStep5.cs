...
{
	/// <summary>
	/// Control que muestra el resumen de información sobre el contenido a
	/// descargar
	/// </summary>
	public class OpenStep5 : TSWizards.BaseStep
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(OpenStep5));
			...
			this.ShowStep += new TSWizards.ShowStepEventHandler(this.OpenStep5_ShowStep);
		...
		private void OpenStep5_ShowStep(object sender, TSWizards.ShowStepEventArgs e)
		{
			this.Wizard.next.Enabled=true;
			this.txtResumen.Text="";
			OpenStep2 step2 = Wizard.GetStep("Step2") as OpenStep2;
			this.txtResumen.Text+=step2.StepTitle+": "+step2.treeView1.SelectedNode.Text+"\r\n";

			OpenStep3 step3 = Wizard.GetStep("Step3") as OpenStep3;
			this.txtResumen.Text+=step3.listView1.Columns[0].Text+": "+step3.listView1.SelectedItems[0].SubItems[0].Text+"\r\n";
			this.txtResumen.Text+=step3.listView1.Columns[1].Text+": "+step3.listView1.SelectedItems[0].SubItems[1].Text+"\r\n";
			this.txtResumen.Text+=step3.listView1.Columns[2].Text+": "+step3.listView1.SelectedItems[0].SubItems[2].Text+"\r\n";

			OpenStep4 step4 = Wizard.GetStep("Step4") as OpenStep4;
			System.IO.DirectoryInfo dinfo=(DirectoryInfo)step4.treedir.SelectedNode.Tag; 
			this.txtResumen.Text+=step4.StepTitle+": "+dinfo.FullName+"\r\n";
