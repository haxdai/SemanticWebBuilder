...
namespace WBExcel
{
	...
	public class FrmDetalleDoc : System.Windows.Forms.Form
	{
		...
		public FrmDetalleDoc()
		{
			...
			FileInfo fdocword= new FileInfo(CExcel.doc.FullName);			

			itemsdoc[0]=resources.GetString("FrmDetalleDoc.msg1");
			itemsdoc[1]=CExcel.doc.Name;
			...
			Excel.Workbook book=CExcel.app.ActiveWorkbook;
			try
			{
                ...
                foreach (Excel.Worksheet worksheet in book.Worksheets)
				{
					...
					for(int i=1;i<=links.Count;i++)						
					{
						...
						if(archivo!=null)
						{
							try
							{
								System.Uri basepath=new System.Uri(CExcel.doc.FullName);
