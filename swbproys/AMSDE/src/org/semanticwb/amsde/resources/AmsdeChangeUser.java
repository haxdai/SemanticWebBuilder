 ...
 */
public class AmsdeChangeUser extends GenericResource {

    private static Logger log = SWBUtils.getLogger(AmsdeChangeUser.class);

    @Override
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        String wsiteID = paramRequest.getWebPage().getWebSiteId();
        String path = "/work/models/"+wsiteID+"/jsp/userRegistry/userEdit.jsp";
    ...
    public void processAction(HttpServletRequest request, SWBActionResponse response) throws SWBResourceException, IOException {
         if ("edit".equals(response.getAction()) && request.getParameter("uri") != null) {
