<%--   
    Document   : view Recurso DiplomadoCursoResource
...
<%
            ...
            long intSize = SWBUtils.Collections.sizeOf(cv.listDiplomados());
            Iterator<Diplomado> ittic = cv.listDiplomados();
...
<%
            ...
            boolean booNoAplica = cv.isSinDiplomado();
            String strChecked ="";
...
<label for="noAplica">No cuento con Diplomados, Cursos o Certificaciones</label>
...
<h3><%=wptitle%></h3>
          <form class="soria" id="form1dc" name="form1" method="post"  action="<%=urladd%>" dojoType="dijit.form.Form">
...
<div class="icv-div-grupo">
  ...
  <p class="icv-3col">
    ...
    <input type="text" name="docobtenido" id="docobtenido" maxlength="100" dojoType="dijit.form.ValidationTextBox" required="true" promptMessage="Ingrese documento obtenido" regExp="[a-zA-Z0-9\u00C0-\u00FF' /_-]+" />
  </p>
<div class="clearer">&nbsp;</div>
</div>
...
<h3><%=wptitle%></h3>
          <form id="form2dc" name="form1" method="post" action="<%=urladd%>" dojoType="dijit.form.Form">
