package mx.gob.se.promexico.portal.swb.resources.sem.slideshow;
...
public class SlideShow extends mx.gob.se.promexico.portal.swb.resources.sem.slideshow.base.SlideShowBase 
{
    private static Logger log = SWBUtils.getLogger(SlideShow.class);
   ...
   */
    public SlideShow(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
