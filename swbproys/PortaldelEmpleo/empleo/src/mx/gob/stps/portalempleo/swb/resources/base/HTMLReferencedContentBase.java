...
public abstract class HTMLReferencedContentBase extends org.semanticwb.portal.resources.sem.HTMLContent implements org.semanticwb.model.ResourceVersionable,org.semanticwb.model.Versionable
{
    ...
    public static final org.semanticwb.platform.SemanticClass portalempleo_HTMLReferencedContent=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticClass("http://www.stps.gob.mx/swb4/portalempleo#HTMLReferencedContent");
    public static final org.semanticwb.platform.SemanticClass sclass=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticClass("http://www.stps.gob.mx/swb4/portalempleo#HTMLReferencedContent");

    public HTMLReferencedContentBase()
    {
    }

   /**
   * Constructs a HTMLReferencedContentBase with a SemanticObject
   * @param base The SemanticObject with the properties for the HTMLReferencedContent
   */
    public HTMLReferencedContentBase(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
