...
public class AtencionEnLinea extends com.infotec.wb.resources.GenericResource
{
  public void doView(HttpServletRequest request, HttpServletResponse response, WBParamRequest paramsRequest)
    throws AFException, IOException
  {
    StringBuilder sb = new StringBuilder(1000);
    PrintWriter out = response.getWriter();
    WBResourceURL url = null;
    url = paramsRequest.getRenderUrl().setMode("edit");
    Set set = paramsRequest.getTopic().getMap().getHome().getSortChildSet(true);
    ...
    sb.append("\n          </tr>");
    sb.append("\n          <tr >");
    sb.append("\n            <td align=\"left\" valign=\"middle\" bgcolor=\"#FFDCBA\" class=\"textmin\" >Indique el Canal sobre el que tiene Dudas: </td>");

    sb.append("\n            <td align=\"left\" valign=\"middle\" bgcolor=\"#FFDCBA\" >");
    sb.append("\n              <select name=\"canal\" id=\"canal\" size=\"1\" class=\"textmin\">");
    sb.append("\n                <option value=\"0\">SELECCIONE UNA OPCI&Oacute;N</option>");

    for (Iterator i$ = set.iterator(); i$.hasNext(); ) { Object o = i$.next();
      String despliegue = ((Topic)o).getDisplayName(paramsRequest.getUser().getLanguage());
  ...
  public void doEdit(HttpServletRequest request, HttpServletResponse response, WBParamRequest paramsRequest)
    throws AFException, IOException
  {
    StringBuilder sb = new StringBuilder(1000);
    PrintWriter out = response.getWriter();
    ...
    AFUtils.log(" >> AtencionEnLinea En doEdit");
    ...
    if ((request.getParameter("tipoUsuario") != null) && (!"".equals(request.getParameter("tipoUsuario")))) {
      ...
      {
        AFUtils.log(nfe, "Al convertir el tipo de usuario en chat");
      }
    }
