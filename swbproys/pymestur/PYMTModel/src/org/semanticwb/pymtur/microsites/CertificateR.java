...
public class CertificateR extends GenericResource{
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        }else
        {
            ...
            out.println("   var s=\"\";");
            out.println("   s = s.concat(\"<div class='conteIframe'>\");");
            out.println("   s = s.concat(\"<iframe class='editIframe'  src='"+url+"'></iframe>\");");
            out.println("   s = s.concat(\"</div>\");");
            out.println("   certif.innerHTML = s;");
            out.println("   document.body.appendChild(certif);}");
            out.println("</script>");
            out.println("<STYLE type=\"text/css\">");
            out.println("     #columnRight .certif{padding-left:14px;}");
            out.println("     #columnRight .certif a{background:none; padding:0px; margin:0px; display:inline; float:left; border:solid 1px #b6b6b6; padding:2px; margin:1px 0 1px 2px; clear:none;width:76px; height:62px; text-align:center}");
            out.println("     #columnRight .certif .img,#columnRight .certif a .img{display:inline-block;}");
            out.println("     #editCertificados {z-Index:10000;position:absolute;top:0%;left:0%;width:100%;height:100%;background-color:#000000}");
            out.println("     #editCertificados .conteIframe{position:absolute; top:0%; left:0%; width:100%; height:100%;}");
            out.println("     #editCertificados .editIframe{z-index: 10005;background-color:white; position: absolute; top: 9%; left: 20%; width: 60%; height: 75%; border: 3px double white; padding: 5px;}");
            out.println(" </STYLE>");
