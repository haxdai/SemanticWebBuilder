...
public class Application extends com.infotec.lodp.swb.base.ApplicationBase 
{
    ...
    public void updateHits()
    {
        ...
        {
            timer = System.currentTimeMillis();
            updateAppDownload(); //setDownloads(hits);
            hitted = false;
        }
    }
    ...
    public void buildView(HttpServletRequest request, HttpServletResponse response, PrintWriter out, User user, WebPage topic, boolean savelog, String content, DistributorParams distparams) 
    {
        ...
        log.debug("<!-- Application1:"+ (System.currentTimeMillis()-tini) +"ms -->");
        ...
        log.debug("<!-- ApplicationFin:"+ (System.currentTimeMillis()-tini) +"ms -->");
    }
