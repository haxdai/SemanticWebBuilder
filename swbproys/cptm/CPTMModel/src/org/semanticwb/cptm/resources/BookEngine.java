 ...
 * @author jose.jimenez
 */
public class BookEngine extends GenericResource {
    ...
    private static Logger log = SWBUtils.getLogger(BookEngine.class);
    ...
    public void setResourceBase(Resource base) throws SWBResourceException {
        ...
        try {
            ...
            BookEngine.log.error("Error while getting BestDay's template.", e);
        }
        try {
            ...
            BookEngine.log.error("Error while getting Travelocity's template.", e);
        }
        ...
        try {
            ...
            BookEngine.log.error("Error while getting Expedia's template.", e);
        }
    }
...
//            out.println(new GenerateHtml().getHtml(doc, xsl));   //todo descomentar este si es generico y comentar el siguiente
            ...
            BookEngine.log.error("Error while generating Best Day's view", e);
        }
    }
 ...
 */
            ...
            BookEngine.log.error("Error while generating Travelocity's form.", e);
        }
    }
    ...
    public void doViewExpidia(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            BookEngine.log.error("Error while generating Expedia's form.", e);
        }
    }
    ...
    public Element getElement(Document doc, String name, String value) {
        ...
        try {
            ...
            BookEngine.log.error("Error while creating DOM element for view.", dome);
        }
        return element;
    }
