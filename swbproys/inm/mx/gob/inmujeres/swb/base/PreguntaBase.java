...
public abstract class PreguntaBase extends org.semanticwb.model.SWBClass 
{
    ...
    public static final org.semanticwb.platform.SemanticProperty inm_numPregunta=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticProperty("http://www.bpmninfotec.com/inm#numPregunta");
...
/**
* Gets the NumPregunta property
* @return int with the NumPregunta
*/
    public int getNumPregunta()
    {
        return getSemanticObject().getIntProperty(inm_numPregunta);
    }

/**
* Sets the NumPregunta property
* @param value long with the NumPregunta
*/
    public void setNumPregunta(int value)
    {
        getSemanticObject().setIntProperty(inm_numPregunta, value);
    }
   /**
