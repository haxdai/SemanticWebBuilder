...
String varSeguimiento = "seguimientoSR";
    ...
    mgr.addProperty(SeguimientoSolicitudRecurso.intranet_modificarSolicitud, varSeguimiento, SWBFormMgr.MODE_EDIT);
    ...
    <form id="<%=foi.getId()%>/form" dojoType="dijit.form.Form" class="swbform" action="<%=urlact%>" method="post">
        ...
        <fieldset>
            <table>
                ...
                <tr>
                    <td width="200px" align="right"><label for="title"><%=fmgr.renderLabel(request, SeguimientoSolicitudRecurso.intranet_modificarSolicitud, varSeguimiento, SWBFormMgr.MODE_VIEW)%></label></td>
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_modificarSolicitud, SWBFormMgr.MODE_EDIT)%>
                    </td>
                </tr>
            </table>
        </fieldset>
