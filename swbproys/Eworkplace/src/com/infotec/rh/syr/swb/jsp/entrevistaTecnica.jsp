...
if (paramRequest.getCallMethod() == SWBParamRequest.Call_DIRECT) {
    ...
    if (act.equals("DO_TEC")) {
        response.setContentType("text/html; charset=UTF-8");
        SWBResourceURL actUrl = paramRequest.getActionUrl().setAction("SET_TEC");
                    ...
                    <fieldset>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" value="true" <%=sc.isApruebaTecnica()?"checked":""%> name="aprueba"/><label>Si</label>
                                    <input type="radio" value="false" <%=sc.isApruebaTecnica()?"":"checked"%> name="aprueba"/><label>No</label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" isValid="return validaPorcentaje(this.value)" regexp="\d{1,3}(\.\d{1,2})?" name="apego" required="true" dojoType="dijit.form.ValidationTextBox" value="<%=sc.getPorcentajeTecnica()%>" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                                        ...
                                        while (pos.hasNext()) {
                                            ...
                                            if (sc.isApruebaEntrevistaTelefonica() && sc.isRealizoPsicometrico() && sc.isApruebaCompetencias() && sc.isPasaEntrevistaTecnica()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span><%=sc.isApruebaTecnica()?"SI":"NO"%></span></td>
