...
//Manejo de peticiones directas
    ...
    mgr.addProperty(SeguimientoSolicitudRecurso.intranet_otraConsultaSuficiencia, varSeguimiento, SWBFormMgr.MODE_EDIT);
        ...
        <fieldset>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_validaAP, SWBFormMgr.MODE_VIEW)%>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_notaValidaSuficienciaAP, SWBFormMgr.MODE_VIEW)%>
                    </td>
                </tr>
                <tr>
                    <td width="200px" align="right"><label for="title"><%=fmgr.renderLabel(request, SeguimientoSolicitudRecurso.intranet_otraConsultaSuficiencia, varSeguimiento, SWBFormMgr.MODE_VIEW)%></label></td>
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_otraConsultaSuficiencia, SWBFormMgr.MODE_EDIT)%>
                    </td>
                </tr>
            </table>
        </fieldset>
