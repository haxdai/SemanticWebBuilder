...
String varSeguimiento = "seguimientoSR";
    ...
    mgr.addProperty(SeguimientoSolicitudRecurso.intranet_fechaAltaPresupuesto, varSeguimiento, SWBFormMgr.MODE_EDIT);
        ...
        <fieldset>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_autorizaDirector, SWBFormMgr.MODE_VIEW)%>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="200px" align="right"><label for="title"><%=fmgr.renderLabel(request, SeguimientoSolicitudRecurso.intranet_fechaAltaPresupuesto, varSeguimiento, SWBFormMgr.MODE_VIEW)%></label></td>
                    <td>
                        <%=fmgr.renderElement(request, varSeguimiento, SeguimientoSolicitudRecurso.intranet_fechaAltaPresupuesto, SWBFormMgr.MODE_EDIT)%>
                    </td>
                </tr>
            </table>
        </fieldset>
