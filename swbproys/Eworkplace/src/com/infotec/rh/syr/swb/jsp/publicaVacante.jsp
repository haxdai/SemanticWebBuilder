...
if (paramRequest.getCallMethod() == SWBParamRequest.Call_DIRECT) {
    ...
    if (act.equals("ADD_PUB")) {
        ...
        pubMgr.addHiddenParameter("ssr", request.getParameter("ssr"));
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        while (pubs.hasNext()) {
                                            ...
                                            if (pub.getArchivoPublicacion() != null) archivo = pub.getArchivoPublicacion();
                                            %>
                                            <tr>
                            ...
                            %>
                            <a href="#" onclick="showFormDialog('<%=urlPub%>');">Agregar publicaci&oacute;n</a>
                        </td>
                    </tr>
                </table>
            </fieldset>
    ...
    <div id="addDialog_<%=foi.getId()%>" dojoType="dijit.Dialog" title="Agregar publicación de vacante" href="#">
    </div>
    <script>
