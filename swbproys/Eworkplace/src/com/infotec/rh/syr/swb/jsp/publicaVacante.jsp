...
<div id="addDialog_<%=foi.getId()%>" dojoType="dijit.Dialog" title="Agregar publicaci�n de vacante">
    <%
...
<script>
    ...
    if(data){
        if(data.status && data.status == "success"){
            ...
            widgetRef.overlay.innerHTML = "Ocurri� un error al cargar " + data.detail+". Recargue la p�gina e intente nuevamente";
