...
public abstract class DocenciaBase extends com.infotec.eworkplace.swb.InvestigacionDocencia 
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       * @return Iterator of com.infotec.eworkplace.swb.Docencia
       */

        public static java.util.Iterator<com.infotec.eworkplace.swb.Docencia> listDocencias(org.semanticwb.model.SWBModel model)
        {
            java.util.Iterator it=model.getSemanticObject().getModel().listInstancesOfClass(sclass);
            return new org.semanticwb.model.GenericIterator<com.infotec.eworkplace.swb.Docencia>(it, true);
        }
       /**
       * Returns a list of com.infotec.eworkplace.swb.Docencia for all models
       * @return Iterator of com.infotec.eworkplace.swb.Docencia
       */

        public static java.util.Iterator<com.infotec.eworkplace.swb.Docencia> listDocencias()
        {
            java.util.Iterator it=sclass.listInstances();
            return new org.semanticwb.model.GenericIterator<com.infotec.eworkplace.swb.Docencia>(it, true);
        }

        public static com.infotec.eworkplace.swb.Docencia createDocencia(org.semanticwb.model.SWBModel model)
        {
            long id=model.getSemanticObject().getModel().getCounter(sclass);
            return com.infotec.eworkplace.swb.Docencia.ClassMgr.createDocencia(String.valueOf(id), model);
        }
       /**
       * Gets a com.infotec.eworkplace.swb.Docencia
       * @param id Identifier for com.infotec.eworkplace.swb.Docencia
       * @param model Model of the com.infotec.eworkplace.swb.Docencia
       * @return A com.infotec.eworkplace.swb.Docencia
       */
        public static com.infotec.eworkplace.swb.Docencia getDocencia(String id, org.semanticwb.model.SWBModel model)
        {
            return (com.infotec.eworkplace.swb.Docencia)model.getSemanticObject().getModel().getGenericObject(model.getSemanticObject().getModel().getObjectUri(id,sclass),sclass);
        }
       /**
       * Create a com.infotec.eworkplace.swb.Docencia
       * @param id Identifier for com.infotec.eworkplace.swb.Docencia
       * @param model Model of the com.infotec.eworkplace.swb.Docencia
       * @return A com.infotec.eworkplace.swb.Docencia
       */
        public static com.infotec.eworkplace.swb.Docencia createDocencia(String id, org.semanticwb.model.SWBModel model)
        {
            return (com.infotec.eworkplace.swb.Docencia)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id,sclass),sclass);
        }
       /**
       * Remove a com.infotec.eworkplace.swb.Docencia
       * @param id Identifier for com.infotec.eworkplace.swb.Docencia
       * @param model Model of the com.infotec.eworkplace.swb.Docencia
       */
       ...
       /**
       * Returns true if exists a com.infotec.eworkplace.swb.Docencia
       * @param id Identifier for com.infotec.eworkplace.swb.Docencia
       * @param model Model of the com.infotec.eworkplace.swb.Docencia
       ...
       */
       ...
       /**
       * Gets all com.infotec.eworkplace.swb.Docencia with a determined NivelDocencia
       * @param value NivelDocencia of the type com.infotec.eworkplace.swb.Nivel
       * @param model Model of the com.infotec.eworkplace.swb.Docencia
       * @return Iterator with all the com.infotec.eworkplace.swb.Docencia
       */

        public static java.util.Iterator<com.infotec.eworkplace.swb.Docencia> listDocenciaByNivelDocencia(com.infotec.eworkplace.swb.Nivel value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<com.infotec.eworkplace.swb.Docencia> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(intranet_nivelDocencia, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all com.infotec.eworkplace.swb.Docencia with a determined NivelDocencia
       ...
       */
        ...
        public static java.util.Iterator<com.infotec.eworkplace.swb.Docencia> listDocenciaByNivelDocencia(com.infotec.eworkplace.swb.Nivel value)
        {
            org.semanticwb.model.GenericIterator<com.infotec.eworkplace.swb.Docencia> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(intranet_nivelDocencia,value.getSemanticObject(),sclass));
            return it;
        }
    }
   ...
   */
    ...
    public void setNivelDocencia(com.infotec.eworkplace.swb.Nivel value)
    {
        if(value!=null)
        {
   ...
   */
    public com.infotec.eworkplace.swb.Nivel getNivelDocencia()
    {
