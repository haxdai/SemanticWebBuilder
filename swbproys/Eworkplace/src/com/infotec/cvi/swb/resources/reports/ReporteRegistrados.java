...
/**
 * Recurso de contenido que permite imprimir el reporte de cv registrados
 *
 * @author juan.fernandez
 */
public class ReporteRegistrados extends GenericResource {
    private Logger log = SWBUtils.getLogger(ReporteRegistrados.class);
