...
/**
 * Recurso de contenido que permite imprimir el reporte por
 *
 * @author juan.fernandez
 */
public class ReporteMatriz extends GenericResource {
    
    private Logger log = SWBUtils.getLogger(ReporteMatriz.class);
