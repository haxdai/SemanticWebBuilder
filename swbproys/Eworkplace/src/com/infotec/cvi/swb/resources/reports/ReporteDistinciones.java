...
/**
 * Recurso de contenido que permite imprimir el reporte por distinciones
 *
 * @author juan.fernandez
 */
public class ReporteDistinciones extends GenericResource {
    
    private Logger log = SWBUtils.getLogger(ReporteDistinciones.class);
