 ...
 */
public class ArticleParser  extends GenericParser {

    private static Logger log = SWBUtils.getLogger(ArticleParser.class);
    ...
    public String getIndexTitle(Searchable gen) {
        ...
        //System.out.println("ARTICLE: index title");
...
//             urlDoc = wsite.getWebPage(strIDShelf).getUrl();
//        }
//        urlDoc +="/_rid/"+res.getId()+"?id="+doc.getId()+"&suri="+doc.getURI();
//        if(CONFIG_WORKSPACE.equals(strConfig)){
//            Iterator<WorkSpace> itws = WorkSpace.ClassMgr.listWorkSpaceByTile(doc);
//            while (itws.hasNext()) {
//                WorkSpace workSpace = itws.next();
