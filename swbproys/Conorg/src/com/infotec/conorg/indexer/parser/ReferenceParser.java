 ...
 */
public class ReferenceParser extends GenericParser {

    private static Logger log = SWBUtils.getLogger(ReferenceParser.class);
    ...
    public String getIndexTitle(Searchable gen) {
        ...
        //System.out.println("REFERENCE: index title");
