...
public class ThemeManager extends org.semanticwb.ecosikan.innova.base.ThemeManagerBase {
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        } else if (paramRequest.getAction().equals("list")) {
            /*PrintWriter out = response.getWriter();
            GenericIterator<Theme> temas = null;
            temas = listThemeses();
            if (temas != null) {
                out.println("<ul>");
                while (temas.hasNext()) {
                    out.println(temas.next().getDescription());
                }
                out.println("</ul>");
            }else{
                out.println("<b>NO HAY TEMAS ACTUALMENTE...</b>");
            }
*/
            path = "/work/models/EcoSikan2/jsp/themes/list.jsp";
        }
