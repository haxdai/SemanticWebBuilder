...
public abstract class LaneBase extends org.semanticwb.process.model.GraphicalElement implements org.semanticwb.model.Descriptiveable,org.semanticwb.process.model.ResourceAssignmentable,org.semanticwb.model.RuleRefable,org.semanticwb.model.RoleRefable,org.semanticwb.model.Referensable,org.semanticwb.model.UserGroupRefable,org.semanticwb.model.Sortable,org.semanticwb.model.Traceable,org.semanticwb.process.model.BPMNSerializable
{
...
/**
* Gets the Lindex property
* @return int with the Lindex
*/
    public int getLindex()
    {
        return getSemanticObject().getIntProperty(swp_lindex);
    }

/**
* Sets the Lindex property
* @param value long with the Lindex
*/
    public void setLindex(int value)
    {
        getSemanticObject().setIntProperty(swp_lindex, value);
    }
