...
//          System.out.println("userRep: "+SWBContext.getUserRepository(obj.getModel().getName()));
            selectValues = SWBContext.getUserRepository(obj.getModel().getName()).getUserRepSecurityQuestionList(lang);
        ...
        if (prop.isObjectProperty()) {
            ...
            if (mode.equals("edit") || mode.equals("create")) {
                ret.append("<select name=\"").append(name).append(
                    "\" dojoType=\"dijit.form.FilteringSelect\" autoComplete=\"true\" invalidMessage=\"").append(
                    imsg).append("\">");
                ...
                ret.append("<span _id=\"").append(name).append("\" name=\"").append(name).append("\">").append(
                    value).append("</span>");
            }
        } else {
