(function(e) {
    window.elFinder = function(t, n) {
            this.time("load");
            var r = this, //instancia del administrador de archivos
                t = e(t),
                ...
                c = !0,
                h = !0,
                p = ["enable", "disable", "load", "open", "reload", "select", "add", "remove", 
                     "change", "dblclick", "getfile", "lockfiles", "unlockfiles", "dragstart", "dragstop"],
                d = {},
                v = "",
                m = {
                    path: "",
                ...
                L, A = function(t) {
                    if (t.init) g = {};
                        ...
                        for (var n in g) g.hasOwnProperty(n) && g[n].mime != "directory" && g[n].phash == v && e.inArray(n, S) === -1 && delete g[n];
                    v = t.cwd.hash, O(t.files), g[v] || O([t.cwd]), r.lastDir(v)
                },
                O = function(e) {  //agrega elementos a la vista de la carpeta seleccionada
                    var t = e.length,
                        n;
                    while (t--) {
                        n = e[t];
                ...
                M = function(t) {
                    ...
                    c && (e.each(w, function(e, s) {
                        s.type == t.type && s.keyCode == n && s.shiftKey == t.shiftKey && 
                                s.ctrlKey == i && s.altKey == t.altKey && 
                                (t.preventDefault(), t.stopPropagation(), s.callback(t, r), r.debug("shortcut-exec", e + " : " + s.description))
            ...
            this.options = e.extend(!0, {}, this._options, n || {}),
            n.ui && (this.options.ui = n.ui),
            n.commands && (this.options.commands = n.commands),
            n.uiOptions && n.uiOptions.toolbar && (this.options.uiOptions.toolbar = n.uiOptions.toolbar),
            e.extend(this.options.contextmenu, n.contextmenu),
            this.requestType = /^(get|post)$/i.test(this.options.requestType) ? this.options.requestType.toLowerCase() : "get",
            this.customData = e.isPlainObject(this.options.customData) ? this.options.customData : {},
            this.id = o,
            this.uploadURL = n.urlUpload || n.url,
            this.resourceId = n.resourceId,
            this.resourcePath = n.resourcePath,
            this.namespace = u,
            this.lang = this.i18[this.options.lang] && this.i18[this.options.lang].messages ? this.options.lang : "en",
            P = this.lang == "en" ? this.i18.en : e.extend(!0, {}, this.i18.en, this.i18[this.lang]),
            ...
            this.today = (new Date(_.getFullYear(), _.getMonth(), _.getDate())).getTime(),
            ...
            this.sortStickFolders === null ? this.sortStickFolders = !!this.options.sortStickFolders : this.sortStickFolders = !!this.sortStickFolders,
            this.sortRules = e.extend(!0, {}, this._sortRules, this.options.sortsRules),
            ...
            this.draggable = {
                ...
                helper: function(t, n) {
                    ...
                    a = i.is("." + r.res("class", "cwdfile")) ? r.selected() : [r.navId2Hash(i.attr("id"))],
                    s.append(o(g[a[0]].mime)).data("files", a).data("locked", !1),
                    (l = a.length) > 1 && s.append(o(g[a[l - 1]].mime) + '<span class="elfinder-drag-num">' + l + "</span>"),
                    e(document).bind(f + " keyup." + u, function(e) {
                        s.is(":visible") && !s.data("locked") && s.toggleClass("elfinder-drag-helper-plus", e.shiftKey || e.ctrlKey || e.metaKey)
                    }), s
                }
            },
            this.droppable = {
            ...
            this.path2array = function(e, t) {
                var n, r = [];
                while (e && (n = g[e]) && n.hash) r.unshift(t && n.i18 ? n.i18 : n.name), e = n.phash;
                return r
            },
            ...
            this.fileByName = function(e, t) {
                var n;
                for (n in g)
                    if (g.hasOwnProperty(n) && g[n].phash == t && g[n].name == e) return g[n]
            },
            ...
            this.request = function(t) {
                var n = this,
                    ...
                    p = function(t) {
                        t.warning && n.error(t.warning), o == "open" && A(e.extend(!0, {}, t)), t.removed && t.removed.length &&
                            n.remove(t), t.added && t.added.length && n.add(t), t.changed && t.changed.length && n.change(t), n.trigger(o, t), t.sync && n.sync()
                    },
                    d = function(e, t) {
                        var n;
                        switch (t) {
                    ...
                    v = function(t) {
                        ...
                        t = n.normalize(t),
                        n.api || (n.api = t.api || 1, n.newAPI = n.api >= 2, n.oldAPI = !n.newAPI),
                                t.options && (m = e.extend({}, m, t.options)), t.netDrivers && (n.netDrivers = t.netDrivers), i.resolve(t), t.debug && n.debug("backend-debug", t.debug)
                    },
                    g, y;
                ...
                if (o == "open")
                    while (y = x.pop()) y.state() == "pending" && (y.quiet = !0, y.abort());
            ...
            this.destroy = function() {
                t && t[0].elfinder && (this.trigger("destroy").disable(),
                    b = {},
                    w = {},
            ...
            this.dragUpload = !1,
            this.xhrUpload = (typeof XMLHttpRequestUpload != "undefined" || typeof XMLHttpRequestEventTarget != "undefined") &&
                                typeof File != "undefined" && typeof FormData != "undefined",
                this.transport = {},
                typeof this.options.transport == "object" && (this.transport = this.options.transport,
                typeof this.transport.init == "function" && this.transport.init(this)),
                typeof this.transport.send != "function" && (this.transport.send = function(t) {
                    return e.ajax(t)
                }),
                this.transport.upload == "iframe"
                    ...
                    : typeof this.transport.upload == "function"
                        ...
                        : this.xhrUpload && !!this.options.dragUploadAllow
                            ? (this.transport.upload = e.proxy(this.uploads.xhr, this), this.dragUpload = !0)
                            : this.transport.upload = e.proxy(this.uploads.iframe, this),
                this.error = function() {
                    var e = arguments[0];
                    return arguments.length == 1 && typeof e == "function" 
                            ? r.bind("error", e) : r.trigger("error", { error: e })
                },
                e.each(["enable", "disable", "load", "open", "reload", "select", "add",
                        "remove", "change", "dblclick", "getfile", "lockfiles", "unlockfiles",
                        "dragstart", "dragstop", "search", "searchend", "viewchange"], function(t, n) {
                    r[n] = function() {
                        var t = arguments[0];
                        return arguments.length == 1 && typeof t == "function"
                                ? r.bind(n, t) : r.trigger(n, e.isPlainObject(t) ? t : {})
                    }
                }),
                this.enable(function() {
                    ...
                    O(e.data.added || [])
                    e.data.confirm && r.confirmUpload(e.data.confirm);
                }).change(function(t) {
                    e.each(t.data.changed || [], function(t, n) {
                        var r = n.hash;
                        if (g[r].width && !n.width || g[r].height && !n.height) g[r].width = undefined, g[r].height = undefined;
                    ...
                    n && n != "" && n != "no" && e(k).html('<source src="/swbadmin/js/elfinder/sounds/rm.wav" type="audio/wav">')[0].play()
                }),
                e.each(this.options.handlers, function(e, t) {
                    r.bind(e, t)
                }),
                this.history = new this.history(this),
                typeof this.options.getFileCallback == "function" && this.commands.getfile && (this.bind("dblclick", function(e) {
                ...
                this._commands = {},
                e.isArray(this.options.commands) || (this.options.commands = []),
            ...
            this.options.width && (N = this.options.width),
            this.options.height && (C = parseInt(this.options.height)),
            r.resize(N, C),
            e(document).bind("click." + this.namespace, function(n) {
                c && !e(n.target).closest(t).length && r.disable()
            }).bind(f + " " + l, M),
            r.options.useBrowserHistory && e(window).on("popstate", function(t) {
                var n = t.originalEvent.state && t.originalEvent.state.thash;
                n && !e.isEmptyObject(r.files()) && r.request({
                    data: {
                        cmd: "open",
                        target: n,
                        onhistory: 1
            ...
            this.trigger("init").request({  //inicia funcionamiento - carga
                data: {
                    cmd: "open",
                    target: r.startDir(),
                    init: 1,
    ...
    elFinder.prototype = {
            ...
            },confirmUpload: function(array) {
                //TODO: agregar cuerpo para confirmacion de carga de archivos repetidos
                var confirmed = [];
                var r = this;
                e.each(array, function (i, v) {
                    if (confirm("File " + v + " already exists. Overwrite?")) {
                        confirmed.push(v)
                    }
                }), this.request({
                        data: {
                            ...
                            filenames: confirmed.toString(),
                            tree: this.ui.tree ? 1 : 0
                        },
                        preventDefault: !0
                    }).done(function(data) {
                    //ejecutar lo mismo que en la carga
                        r.warning && r.error(data.warning),
                            data.removed && r.remove(data),
                            data.added && r.add(data),
                            data.changed && r.change(data),
                            r.trigger("upload", data),
                            data.sync && r.sync()
                });
                
//                for (int i = 0; i < array.length; i++) {
//                    
//                        confirmed += (confirmed.length > 0 ? ("|" + confirmed[i]) : confirmed[i]);
//                    }
//                }
...
//                }
            ...
            uploads: {
                ...
                xhr: function(t, n) {
                    var r = n ? n : this,
                        ...
                        h;
                    //Agregar a s, el valor del id del recurso almacenado en resourceId
                    if (!a) return i.reject();
                    
                    //validar tamaño de archivos a enviar
                    var fileSizeExceeded = false;
                    for (var nfile = 0; nfile < u.length; nfile++) {
                        if (u[nfile].size > 2147483648) { //limite de 2 GB por archivo
                            fileSizeExceeded = true;
                        }
                    }
                    //Para mostrar mensaje de error (tamanio_archivo > 2GB --jetty)
                    if (fileSizeExceeded) {
                       i.reject(["errUploadFileSize", "errAbort"]);
                    } else {
                    ...
                    s.addEventListener("filesizeerror", function() {
                            i.reject(["errUploadFileSize", "errAbort"])
                        }, !1),
                    s.addEventListener("load", function() {
                            var e = s.status, t;
                            if (e > 500) return i.reject("errResponse");
                            if (e >= 400) return i.reject("errConnect");
                    ...
                    s.upload.addEventListener("progress", function(e) {
                        var t = f, n;
                        e.lengthComputable && (n = parseInt(e.loaded * 100 / e.total),
                                               n > 0 && !h && (h = c()),
                                               n - t > 4 && (f = n, l && r.notify({
                                                    type: "upload",
                                                    cnt: 0,
                                                    progress: (f - t) * a
                                                })))
                        }, !1),
                    s.open("POST", r.uploadURL, !0),
                    o.append("cmd", "upload"),
                    o.append(r.newAPI ? "target" : "current", r.cwd().hash),
                    e.each(r.options.customData, function(e, t) { o.append(e, t)}),
                    s.setRequestHeader("resourceId", r.options.resourceId),
                    s.setRequestHeader("resourcePath", r.options.resourcePath),
                    ...
                    s.onreadystatechange = function() {
                        //si la peticion se completo pero la respuesta tiene estado 0 (exitosa = 200)
                    ...
                    if (!fileSizeExceeded && (!this.UA.Safari || !t.files)) h = c();
                    return i
                }
            },
            one: function(t, n) {
            ...
            normalize: function(t) {
                var n = function(e) {
                    return e && e.hash && e.name && e.mime
                            ? (e.mime == "application/x-empty" && (e.mime = "text/plain"), e)
                            : null
                };
                return t.files && (t.files = e.map(t.files, n)),
                        t.tree && (t.tree = e.map(t.tree, n)),
                        t.added && (t.added = e.map(t.added, n)),
                        t.changed && (t.changed = e.map(t.changed, n)),
                        t.toconfirm && (t.toconfirm = e.map(t.toconfirm, n)),
                        t.api && (t.init = !0),
                        t
            },
            ...
            _sortRules: {
                name: function(e, t) {
                    ...
                    typeof n.loc == "undefined" && (n.loc = navigator.userLanguage || navigator.browserLanguage || navigator.language || "en-US"), typeof n.sort == "undefined" && ("11".localeCompare("2", n.loc, {
                        numeric: !0
                        ...
                        var r = /(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,
                            i = /(^[ ]*|[ ]*$)/g,
                            s = /(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,
                            o = /^0x[0-9a-f]+$/i,
                            u = /^0/,
                            a = /^[\x01\x21-\x2f\x3a-\x40\x5b-\x60\x7b-\x7e]/,
                            f = function(e) {
                                return n.sort.insensitive && ("" + e).toLowerCase() || "" + e
                            },
                            l = f(e).replace(i, "").replace(/^_/, "") || "",
                            c = f(t).replace(i, "").replace(/^_/, "") || "",
                            h = l.replace(r, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"),
                            p = c.replace(r, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"),
                            d = parseInt(l.match(o)) || h.length != 1 && l.match(s) && Date.parse(l),
                            v = parseInt(c.match(o)) || d && c.match(s) && Date.parse(c) || null,
                            m, g, y = 0;
                        if (v) {
                            if (d < v) return -1;
                            if (d > v) return 1
                        }
                        for (var b = 0, w = Math.max(h.length, p.length); b < w; b++) {
                            m = !(h[b] || "").match(u) && parseFloat(h[b]) || h[b] || 0, g = !(p[b] || "").match(u) && parseFloat(p[b]) || p[b] || 0;
                            if (isNaN(m) !== isNaN(g)) {
                                if (isNaN(m) && (typeof m != "string" || !m.match(a))) return 1;
                                if (typeof g != "string" || !g.match(a)) return -1
                            }
                            parseInt(m, 10) === 0 && (m = 0), parseInt(g, 10) === 0 && (g = 0), typeof m != typeof g && (m += "", g += "");
                            if (n.sort.insensitive && typeof m == "string" && typeof g == "string") {
                                y = m.localeCompare(g, n.loc);
                                if (y !== 0) return y
                            }
                            if (m < g) return -1;
                            if (m > g) return 1
                    ...
                    var r = e.name.toLowerCase(),
                        ...
                        o = "",
                        u, a;
                    if (u = r.match(/^(.+)(\.[0-9a-z.]+)$/)) r = u[1], s = u[2];
                    if (u = i.match(/^(.+)(\.[0-9a-z.]+)$/)) i = u[1], o = u[2];
                    return a = n.sort(r, i), a == 0 && (s || o) && s != o && (a = n.sort(s, o)), a
                },
                size: function(e, t) {
            ...
            i18n: function() {
                var t = this,
                    ...
                    s = function(e) {
                        var n;
                        if (e.indexOf("#") === 0)
                            if (n = t.file(e.substr(1))) return n.name;
                        return e
                    },
                    o, u, a;
                for (o = 0; o < arguments.length; o++) {
                    ...
                    if (typeof a == "string") r.push(s(a));
                        ...
                        for (u = 0; u < a.length; u++) typeof a[u] == "string" && r.push(s(a[u]))
                }
            ...
            formatDate: function(e, t) {
                ...
                return n.options.clientFormatDate && t > 0 ? (i = new Date(t), c = i[n.getHours](), h = c > 12 ? c - 12 : c, p = i[n.getMinutes](), d = i[n.getSeconds](), u = i[n.getDate](), a = i[n.getDay](), f = i[n.getMonth]() + 1, l = i[n.getFullYear](), s = t >= this.yesterday ? this.fancyFormat : this.dateFormat, o = s.replace(/[a-z]/gi, function(e) {
                    switch (e) {
                        case "d":
                            return u > 9 ? u : "0" + u;
                        case "j":
        ...
        e.fn.elfinder = function(e) {
            ...
            contextmenu: {
                ...
                cwd: ["reload", "back", "|", "upload", "mkdir", "paste", "|", "sort", "|", "info"], //, "mkfile"
                files: ["getfile", "|", "download", "|", "copy", "cut", "paste", "duplicate", "|", "rm", "|", "rename", "|", "info"] //"open", "quicklook", "|", "edit", "resize", "|", "archive", "extract", 
            },
            ...
            var n = this,
                ...
                u = t.options.useBrowserHistory &&
                window.history && window.history.pushState ? window.history : null,
                a = function(u) {
            ...
            this.canBack = function() {
                ...
                return s < i.length - 1
            }, this.back = a, this.forward = function() {
                return a(!0)
            }, t.open(function(e) {
                var n = i.length,
                    o = t.cwd().hash;
                r && (s >= 0 && n > s + 1 && i.splice(s + 1), i[i.length - 1] != o && i.push(o), s = i.length - 1), r = !0, u && (u.state ? u.state.thash != o && u.pushState({
                    thash: o
                }, null, location.pathname + location.search + "#elf_" + o) : u.replaceState({
                    thash: o
                }, null, location.pathname + location.search + "#elf_" + o))
            }).reload(o)
                ...
                make: function() {
                    var t = this.fm,
                        ...
                        i = e.Deferred().fail(function(e) {
                            r.trigger("unselectall"), e && t.error(e)
                        }).always(function() {
                    ...
                    return this.disabled() || !f.length ? i.reject() : (t.disable(), f.find(".elfinder-cwd-filename").empty("").append(l.val(a.name)), l.select().focus(), l[0].setSelectionRange && l[0].setSelectionRange(0, a.name.replace(/\..+$/, "").length), i)
                }
            }
                ...
                var n = e(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all elfinder-contextmenu elfinder-contextmenu-" + t.direction).hide().appendTo("body").delegate(".elfinder-contextmenu-item", "mouseenter mouseleave", function() {
                    ...
                    u = function(i, s) {
                        var o = e(window),
                            ...
                            p = t.UA.Touch ? 10 : 0,
                            d = {
                                top: (s + p + a < l ? s + p : s - p - a > 0 ? s - p - a : s + p) + c,
                                left: (i + p + u < f ? i + p : i - p - u) + h,
                                "z-index": 100 + t.getUI("workzone").zIndex()
                            };
                        n.css(d).show(), d = {
                            "z-index": d["z-index"] + 10
                        }, d[r] = parseInt(n.width()), n.find(".elfinder-contextmenu-sub").css(d)
                    },
                    a = function() {
                        n.hide().empty()
                    },
                        ...
                        e.each(i[r] || [], function(r, i) {
                            ...
                            if (f && f.getstate(s) != -1) {
                                if (f.variants) {
                                    ...
                                    l = o(f.title, f.name, function() {}), c = e('<div class="ui-corner-all elfinder-contextmenu-sub"/>').appendTo(l.append('<span class="elfinder-contextmenu-arrow"/>')), h = function() {
                                        var t = e(window),
                                            n = e(l).offset().left,
                                            r = e(l).offset().top,
                                            i = e(l).outerWidth(),
                                            s = c.outerWidth(),
                                            o = c.outerHeight(),
                                            u = t.scrollLeft() + t.width(),
                                            a = t.scrollTop() + t.height(),
                                            f = 5,
                                            h, p, d;
                                        d = n + i + s + f - u, h = d > 0 ? i - d : i, d = r + 5 + o + f - a, p = d > 0 ? 5 - d : 5;
                                        var v = {
                                            left: h,
                                            top: p
                                        };
                                        ...
                                        return l.hasClass("ui-state-hover") ? !0 : (l.addClass("ui-state-hover"), e.preventDefault(), h(), !1)
                                    }), e.each(f.variants, function(t, n) {
                                        c.append(e('<div class="elfinder-contextmenu-item"><span>' + n[1] + "</span></div>").on("click touchstart", function(e) {
            ...
            return this.not(".elfinder-cwd").each(function() {
                var r = t.viewType == "list",
                    ...
                    w = "",
                    E = [],
                    //S: define la estructura de la informacion a mostrar para cada elemento mostrado (como icono o renglon de la lista de detalles)
                    S = {
                        ...
                        row: '<tr id="{hash}" class="' + l + ' {permsclass} {dirclass}" title="{tooltip}"><td><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td>{date}</td><td>{size}</td><td>{kind}</td></tr>'   //<td>{perms}</td>
                    },
                    x = t.res("tpl", "perms"),
                    T = t.res("tpl", "symlink"),
                    N = {
                    ...
                    L = function(t, n) {
                        ...
                        if (a.length) {
                            ...
                            if (!d.length) c = l;
                                ...
                                if (u) {
                                    do c = c.prev("[id]"); while (c.length && !(c.position().top < v && c.position().left <= m));
                                    c.is("." + p) && (c = g(c, "next"))
                                } else {
                                    do c = c.next("[id]"); while (c.length && !(c.position().top > v && c.position().left >= m));
                                    c.is("." + p) && (c = g(c, "prev")), c.length || (d = K.find("[id]:not(." + p + "):last"), d.position().top > v && (c = d))
                                }
                            }
                        } else c = K.find("[id]:not(." + p + "):not(.elfinder-cwd-parent):" + (u ? "last" : "first"));
                        c && c.length && !c.is(".elfinder-cwd-parent") && (n ? c = l.add(l[u ? "prevUntil" : "nextUntil"]("#" + c.attr("id"))).add(c) : a.trigger(o), c.trigger(s), H(c.filter(u ? ":first" : ":last")), P())
                    },
                    A = [],
                    O = function(e) {
                        K.find("#" + e).trigger(s)
                    ...
                    M = function() {
                        var n = t.cwd().hash;
                        K.find("[id]:not(." + h + "):not(.elfinder-cwd-parent)").trigger(s), A = e.map(t.files(), function(e) {
                            return e.phash == n ? e.hash : null
                        }), P()
                    },
                    _ = function() {
                        A = [], K.find("[id]." + h).trigger(o), P()
                    },
                    D = function() {
                        return A
                    },
                    ...
                    H = function(e) {
                        var t = e.position().top,
                            ...
                            r = Q.scrollTop(),
                            i = Q.innerHeight();
                        t + n > r + i ? Q.scrollTop(parseInt(t + n - i)) : t < r && Q.scrollTop(t)
                    },
                    B = [],
                    j = function(e) {
                        var t = B.length;
                        while (t--)
                            if (B[t].hash == e) return t;
                        return -1
                    },
                    ...
                    I = function() {
                        var n = [],
                            ...
                            c;
                        if (!B.length) return Q.unbind(F);
                        while ((!a.length || a.position().top <= Q.height() + Q.scrollTop() + t.options.showThreshold) && (c = B.splice(0, t.options.showFiles)).length) n = e.map(c, function(e) {
                            return e.hash && e.name ? (e.mime == "directory" && (i = !0), e.tmb && (e.tmb === 1 ? o.push(e.hash) : u[e.hash] = e.tmb), C(e)) : null
                        }), l.append(n.join("")), a = K.find("[id]:last"), f && K.scrollTop(0);
                        U(u), o.length && z(o), i && R(), A.length && l.find("[id]:not(." + h + "):not(.elfinder-cwd-parent)").each(function() {
                            var t = this.id;
                    ...
                    q = e.extend({}, t.droppable, {
                        over: function(n, r) {
                            ...
                            e.each(r.helper.data("files"), function(e, n) {
                                if (t.file(n).phash == i) return K.removeClass(g), !1
                            })
                        }
                    }),
                    R = function() {
                        ...
                        var n = r ? K.find("tbody") : K,
                            ...
                            f = function(e) {
                                var n = B.length,
                                    r;
                                for (r = 0; r < n; r++)
                                    if (t.compare(e, B[r]) < 0) return r;
                                return n || -1
                            },
                            l, c, h, p;
                        while (i--) {
                            l = e[i], c = l.hash;
                            if (K.find("#" + c).length) continue;
                            (h = a(l)) && h.length ? h.before(C(l)) : (p = f(l)) >= 0 ? B.splice(p, 0, l) : n.append(C(l)), K.find("#" + c).length && (l.mime == "directory" ? u = !0 : l.tmb && (l.tmb === 1 ? s.push(c) : o[c] = l.tmb))
                        }
                        U(o), s.length && z(s), u && R()
                    },
                    X = function(e) {
                        var n = e.length,
                            r, i, s;
                        while (n--) {
                            r = e[n];
                            if ((i = K.find("#" + r)).length) try {
                                i.detach()
                            } catch (o) {
                                t.debug("error", o)
                            } else(s = j(r)) != -1 && B.splice(s, 1)
                        }
                    },
                    V = {
                        name: t.i18n("name"),
                    ...
                    J = function(i, s) {  //Encabezado de vista detalles
                        var o = t.cwd().hash;
                        _();
                        try {
                        ...
                        r && K.html('<table><thead><tr class="ui-state-default"><td class="elfinder-cwd-view-th-name">' + V.name +
                                    '</td><td class="elfinder-cwd-view-th-date">' + V.mod +  //<td class="elfinder-cwd-view-th-perm">' + V.perm + '</td>
                                    '</td><td class="elfinder-cwd-view-th-size">' + V.size + '</td><td class="elfinder-cwd-view-th-kind">' + V.kind +
                                    "</td></tr></thead><tbody/></table>"),
                        B = e.map(i, function(e) {
                            return s || e.phash == o ? e : null
                        }),
                        B = t.sortFiles(B), Q.bind(F, I).trigger(F), o = t.cwd().phash;
                        if (n.oldSchool && o && !w) {
                    ...
                    K = e(this).addClass("ui-helper-clearfix elfinder-cwd").attr("unselectable", "on").delegate(c, "click." + t.namespace, function(n) {
                        ...
                        if (n.shiftKey && (a || f)) l = a ? r.prevUntil("#" + i.attr("id")) : r.nextUntil("#" + u.attr("id")), l.add(r).trigger(s);
                        else if (n.ctrlKey || n.metaKey) r.trigger(r.is("." + h) ? o : s);
                        else {
                            if (r.data("touching") && r.is("." + h)) {
                                r.data("touching", null), t.dblclick({
                                    file: this.id
                                }), _();
                                return
                            }
                        ...
                        n.stopPropagation();
                        if (n.target.nodeName == "INPUT") return;
                        var r = this.id ? e(this) : e(this).parents("[id]:first"),
                            i = r.prevAll("." + h + ":first").length + r.nextAll("." + h + ":first").length;
                        K.data("longtap", null), r.data("touching", !0), r.data("tmlongtap", setTimeout(function() {
                            K.data("longtap", !0);
                            if (r.is("." + h) && i > 0) r.trigger(o), P();
                            else if (n.target.nodeName != "TD" || t.selected().length > 0) r.trigger(s), P(), r.trigger(t.trigger("contextmenu", {
                                type: "files",
                                targets: t.selected(),
                        ...
                        t.stopPropagation();
                        if (t.target.nodeName == "INPUT") return;
                        ...
                        var n = e(this),
                            r = n.attr("id");
                        !k && !n.is("." + p) && (n.addClass(h).children().addClass(m), e.inArray(r, A) === -1 && A.push(r))
                    }).delegate(c, o, function(t) {
                        var n = e(this),
                            r = n.attr("id"),
                            i;
                        k || (e(this).removeClass(h).children().removeClass(m), i = e.inArray(r, A), i !== -1 && A.splice(i, 1))
                        ...
                        r.length && (n.target.nodeName != "TD" || e.inArray(r.get(0).id, t.selected()) > -1) && (n.stopPropagation(), n.preventDefault(), !r.is("." + p) && !r.data("touching") && (r.is("." + h) || (_(), r.trigger(s), P()), t.trigger("contextmenu", {
                            type: "files",
                            targets: t.selected(),
                            x: n.clientX,
                            y: n.clientY
                        ...
                        if (K.data("longtap")) {
                            e.stopPropagation();
                            return
                        }!e.shiftKey && !e.ctrlKey && !e.metaKey && _()
                    }).selectable({
                        filter: c,
                        stop: P,
                        delay: 250,
                        ...
                        var i = r ? K.find("tbody") : K,
                            ...
                            n = e(C(n)).addClass(y);
                        _(), s.length ? s.after(n) : i.prepend(n), K.scrollTop(0)
                    }).bind("unselectall", _).bind("selectfile", function(e, t) {
                        K.find("#" + t).trigger(s), P()
                    }),
                    Q = e('<div class="elfinder-cwd-wrapper"/>').bind("contextmenu", function(e) {
                        ...
                        var r = e(this);
                        K.data("longtap", null), r.data("touching", !0), r.data("tmlongtap", setTimeout(function() {
                            K.data("longtap", !0), t.trigger("contextmenu", {
                                type: "cwd",
                                targets: [t.cwd().hash],
                                x: n.originalEvent.touches[0].clientX,
                                y: n.originalEvent.touches[0].clientY
                    ...
                    }).bind("touchmove." + t.namespace + " touchend." + t.namespace, function(t) {
                ...
                e("body").on("touchstart touchmove touchend", function(e) {}),
                t.dragUpload && (Q[0].addEventListener("dragenter", function(e) {
                    e.preventDefault(), e.stopPropagation(), Q.addClass(g)
                }, !1), Q[0].addEventListener("dragleave", function(e) {
                    e.preventDefault(), e.stopPropagation(), e.target == K[0] && Q.removeClass(g)
                }, !1), Q[0].addEventListener("dragover", function(e) {
                    e.preventDefault(), e.stopPropagation()
                }, !1), Q[0].addEventListener("drop", function(e) {
                    e.preventDefault(), Q.removeClass(g), e.dataTransfer && e.dataTransfer.files && e.dataTransfer.files.length && t.exec("upload", {
                        files: e.dataTransfer.files
                    })
                }, !1)), t.bind("open", function(e) {
                    J(e.data.files)
                }).bind("search", function(e) {
                    E = e.data.files, J(E, !0)
                    ...
                    i != r && (r = i, J(w ? E : t.files(), !!w), e.each(n, function(e, t) {
                        O(t)
                    }), P()), G()
                }).add(function(n) {
                    var r = t.cwd().hash,
                    ...
                    w ? e.each(n.data.changed || [], function(t, n) {
                        X([n.hash]), n.name.indexOf(w) !== -1 && (W([n]), e.inArray(n.hash, i) !== -1 && O(n.hash))
                    }) : e.each(e.map(n.data.changed || [], function(e) {
                        return e.phash == r ? e : null
                    }), function(t, n) {
                        X([n.hash]), W([n]), e.inArray(n.hash, i) !== -1 && O(n.hash)
                    }), P()
                }).remove(function(e) {
                    X(e.data.removed || []), P()
                }).bind("open add search searchend", function() {
                    K.css("height", "auto"), K.outerHeight(!0) < Q.height() && K.height(Q.height() - (K.outerHeight(!0) - K.height()) - 2)
                }).dragstart(function(t) {
                    var n = e(t.data.target),
                        r = t.data.originalEvent;
                    n.is(c) && (n.is("." + h) || (!(r.ctrlKey || r.metaKey || r.shiftKey) && _(), n.trigger(s), P()), K.droppable("disable")), K.selectable("disable").removeClass(p), k = !0
                }).dragstop(function() {
                    K.selectable("enable").droppable("enable"), k = !1
                }).bind("lockfiles unlockfiles", function(e) {
                    var t = e.type == "lockfiles" ? u : a,
                        n = e.data.files || [],
                        r = n.length;
                    while (r--) K.find("#" + n[r]).trigger(t);
                    P()
                }).bind("mkdir mkfile duplicate upload rename archive extract", function(n) {
                    var r = t.cwd().hash,
                        i;
                    _(), e.each(n.data.added || [], function(e, t) {
                    ...
                    callback: function(e) {
                        _(), H(K.find("[id]:first").trigger(s)), P()
                    }
                }).shortcut({
                    pattern: "end",
                    description: "selectlfile",
                    callback: function(e) {
                        _(), H(K.find("[id]:last").trigger(s)), P()
                    }
                })
            }), this
            ...
            return typeof t == "string" && (n = this.closest(".ui-dialog")).length && (t == "open" ? n.css("display") == "none" && n.fadeIn(120, function() {
                ...
                var n = e(this).addClass("ui-dialog-content ui-widget-content"),
                    ...
                    h = e('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' + s + " " + t.cssClass + '"/>').hide().append(n).appendTo(r).draggable({
                        ...
                        h.trigger("totop"), typeof t.open == "function" && e.proxy(t.open, n[0])(), h.is("." + o) || r.find("." + s + ":visible").not("." + o).each(function() {
                            var t = e(this),
                        ...
                        var i = r.find(".elfinder-dialog:visible"),
                            s = p();
                        e(this).data("modal") && f.elfinderoverlay("hide"), i.length ? i.each(function() {
                            var t = e(this);
                        ...
                        e(this).mousedown().find(".ui-button:first").focus().end().find(":text:first").focus(), e(this).data("modal") && f.elfinderoverlay("show"), f.zIndex(e(this).zIndex())
                    }).data({
                        modal: t.modal
                    }),
                    p = function() {
            ...
            return this.each(function() {
                ...
                e('<span class="ui-icon ui-icon-search" title="' + t.title + '"/>').appendTo(r).click(i), e('<span class="ui-icon ui-icon-close"/>').appendTo(r).click(s), setTimeout(function() {
                    ...
                    if (t.fm.UA.ltIE7) {
                        ...
                        e.css({
                            right: "",
                            left: parseInt(r.width()) - e.outerWidth(!0)
                        })
                    }
            ...
            return this.not(".elfinder-toolbar").each(function() {
                ...
                while (o--)
                    if (s[o]) {
                        ...
                        while (u--)
                            if (a = r[s[o][u]]) l = "elfinder" + a.options.ui, e.fn[l] && f.prepend(e("<div/>")[l](a));
                        f.children().length && i.prepend(f), f.children(":gt(0)").before('<span class="ui-widget-content elfinder-toolbar-button-separator"/>')
                    }
            ...
            return this.not("." + r).each(function() {
                var i = "class",
                    ...
                    k = function(e) {
                        return e.name = t.escape(e.i18 || e.name), x.replace(/(?:\{([a-z]+)\})/ig, function(t, n) {
                    ...
                    M = function(e) {
                        ...
                        while (i--) {
                            ...
                            (u = A(s.phash)).length ? (o = k(s), s.phash && (a = O(u, s)).length ? a.before(o) : (u[f || s.phash ? "append" : "prepend"](o), f = !1)) : r.push(s)
                        }
                    ...
                    _ = function(e) {
                        var r = t.cwd().hash,
                            ...
                            f, h;
                        o && (f = H.find("#" + t.navHash2Id(t.root())), f.is("." + c) && f.addClass(l).next("." + u).show(), o = !1), i.is("." + p) || (H.find("." + a + "." + p).removeClass(p), i.addClass(p));
                        if (n.syncTree) {
                            if (i.length) return i.parentsUntil("." + s).filter("." + u).show().prev("." + a).addClass(l);
                            if (t.newAPI) {
                                h = t.file(r);
                                if (h && h.phash && H.find("#" + t.navHash2Id(h.phash)).length) return M([h]), _();
                                t.request({
                                    data: {
                                        cmd: "parents",
                                        target: r
                ...
                t.open(function(e) {
                    ...
                    e.each(s, function(e, n) {
                        ...
                        s.length && (s.is("." + g) && s.draggable(i), s.is("." + y) && s.droppable(i), s[r ? "addClass" : "removeClass"](m))
                    })
                })
            }), this
            ...
            return this.not("." + n).each(function() {
                ...
                i.add(window).bind("resize", function() {
                    ...
                    i.children(":visible:not(." + n + ")").each(function() {
                        var t = e(this);
                        t.css("position") != "absolute" && t.css("position") != "fixed" && (s -= t.outerHeight(!0))
                    }), t.height(s - r)
                })
            }), this
            ...
            this.shortcuts = [{
                ...
                a = e.param(n.options.customData || {}), a && (a = "&" + a), i += i.indexOf("?") === -1 ? "?" : "&";
                for (f = 0; f < s.length; f++) u += '<iframe class="downloader" id="downloader-' + s[f].hash + '" style="display:none" src="' +
                    i + "cmd=file&target=" + s[f].hash + "&download=1" + a + '"/>';
            ...
            this.disableOnSearch = !0, n.bind("open reload", function() {
                ...
                var d = function(e) {
                    ...
                    v = function(t) {
                        !t.read || !n.file(t.phash).write ? (a = ["errExtract", t.name, "errPerm"], n.error(a), s.reject(a)) : e.inArray(t.mime, r) === -1 ? (a = ["errExtract", t.name, "errNoArchive"], n.error(a), s.reject(a)) : n.request({
                            data: {
                                cmd: "extract",
                                target: t.hash
                            },
                    ...
                    m = function(t, r) {
                        var i = t[r],
                            a = i.name.replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/ig, ""),
                            g = e.inArray(a, h) >= 0;
                        g && p[a].mime != "directory" ? n.confirm({
                            title: n.i18n("ntfextract"),
                            text: n.i18n(["errExists", a, "confirmRepl"]),
                            accept: {
                                label: "btnYes",
                                callback: function(e) {
                                    f = e ? "overwrite_all" : "overwrite", d(f);
                                    if (!l && !c) "overwrite" == f && v(i), r + 1 < o ? m(t, r + 1) : s.resolve();
                                    else if (l) {
                                        for (u = 0; u < o; u++) v(t[u]);
                                        s.resolve()
                                    }
                            ...
                            reject: {
                                label: "btnNo",
                                callback: function(e) {
                                    f = e ? "omit_all" : "omit", d(f), !l && !c && r + 1 < o ? m(t, r + 1) : c && s.resolve()
                                }
                            },
                            cancel: {
                                label: "btnCancel",
                            ...
                            all: o > 1
                        }) : (v(i), r + 1 < o ? m(t, r + 1) : s.resolve())
                    };
                return this.enabled() && o && r.length ? (o > 0 && m(i, 0), s) : s.reject()
            }
...
//                            v.push(i[l](o, "https://github.com/Studio-42/elFinder")[l](u, t.i18n("github"))),
                            ...
                            v.push('<div class="' + p + '">Copyright © 2009-2015, Studio 42</div>'),
                            v.push('<div class="' + p + '">„ …' + t.i18n("dontforget") + " ”</div>"),
                            v.push("</div>")
                },
                b = function() {
                    var n = t.shortcuts();
                    v.push('<div id="shortcuts" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), n.length ? (v.push('<div class="ui-widget-content elfinder-help-shortcuts">'), e.each(n, function(e, t) {
                        v.push(m.replace(/\{pattern\}/, t[0]).replace(/\{descrip\}/, t[1]))
                    }), v.push("</div>")) : v.push('<div class="elfinder-help-disabled">' + t.i18n("shortcutsof") + "</div>"), v.push("</div>")
                },
                w = function() {
                    v.push('<div id="help" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), v.push('<a href="http://elfinder.org/forum/" target="_blank" class="elfinder-dont-panic"><span>DON\'T PANIC</span></a>'), v.push("</div>")
                },
                E = "";
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [{
                ...
                }), v.push("</ul>"), e.inArray("about", r) !== -1 && y(), e.inArray("shortcuts", r) !== -1 && b(), e.inArray("help", r) !== -1 && w(), v.push("</div>"), E = e(v.join("")), E.find(".ui-tabs-nav li").hover(function() {
                    e(this).toggleClass("ui-state-hover")
                }).children().click(function(t) {
                    var n = e(this);
                    t.preventDefault(), t.stopPropagation(), n.is(".ui-tabs-selected") || (n.parent().addClass("ui-tabs-selected ui-state-active").siblings().removeClass("ui-tabs-selected").removeClass("ui-state-active"), E.find(".ui-tabs-panel").hide().filter(n.attr("href")).show())
                }).filter(":first").click()
            }, 200), this.getstate = function() {
                return 0
            }, this.exec = function() {
                this.dialog || (E.find("#apiver").text(this.fm.api), this.dialog = this.fm.dialog(E, {
                    title: this.title,
                    width: 530,
                    autoOpen: !1,
                    destroyOnClose: !1
            ...
            this.tpl = {
                ...
                var n = this.files(t);
                n.length || (n = this.files([this.fm.cwd().hash]));
                var s = this,
                    o = this.fm,
                    u = this.options,
                    a = this.tpl,
                    ...
                    m = [],
                    g = function(e) {
                        b.find("." + r).parent().text(e)
                    },
                    y = o.namespace + "-info-" + e.map(n, function(e) {
                        return e.hash
                    }).join("-"),
                    b = o.getUI().find("#" + y),
                    w, E, S, x, T;
                if (!l) return e.Deferred().reject();
                if (b.length) return b.elfinderdialog("toTop"), e.Deferred().resolve();
                if (l == 1) {
                    S = n[0],
                        h = h.replace("{class}",
                        o.mime2class(S.mime)),
                        x = a.itemTitle.replace("{name}", o.escape(S.i18 || S.name)).replace("{kind}", o.mime2kind(S)),
                        S.tmb && (E = o.option("tmbUrl") + S.tmb),
                        S.read ? S.mime != "directory" || S.alias ? w = o.formatSize(S.size) : (w = a.spinner.replace("{text}", i.calc), m.push(S.hash)) : w = i.unknown,
                        c.push(f.replace(p, i.size).replace(d, w)),
                        S.alias && c.push(f.replace(p, i.aliasfor).replace(d, S.alias)),
                        c.push(f.replace(p, i.path).replace(d, o.escape(o.path(S.hash, !0))));
                    if (S.read) {
                        var N;
                        if (u.nullUrlDirLinkSelf && S.mime == "directory" && S.url === null) {
                            var C = window.location;
                            N = C.pathname + C.search + "#elf_" + S.hash
                        } else N = o.url(S.hash);
                        //Comentario siguiente para que el usuario no pueda descargar desde aqui los archivos
//                        if (S.mime !== "directory") {
//                            c.push(f.replace(p, i.link).replace(d, '<a href="' + N + '" target="_blank">' + S.name + "</a>")) //
//                        }
                    }
                    S.dim ? c.push(f.replace(p, i.dim).replace(d, S.dim)) : S.mime.indexOf("image") !== -1 && (S.width && S.height ? c.push(f.replace(p, i.dim).replace(d, S.width + "x" + S.height)) : (c.push(f.replace(p, i.dim).replace(d, a.spinner.replace("{text}", i.calc))), o.request({
                        data: {
                            cmd: "dim",
                            target: S.hash
                        },
                    ...
                    }))), c.push(f.replace(p, i.modify).replace(d, o.formatDate(S))), c.push(f.replace(p, i.perms).replace(d, o.formatPermissions(S))), c.push(f.replace(p, i.locked).replace(d, S.locked ? i.yes : i.no))
                } else h = h.replace("{class}", "elfinder-cwd-icon-group"), x = a.groupTitle.replace("{items}", i.items).replace("{num}", l), T = e.map(n, function(e) {
                    return e.mime == "directory" ? 1 : null
                }).length, T ? (c.push(f.replace(p, i.kind).replace(d, T == l ? i.folders : i.folders + " " + T + ", " + i.files + " " + (l - T))), c.push(f.replace(p, i.size).replace(d, a.spinner.replace("{text}", i.calc))), m = e.map(n, function(e) {
                    return e.hash
                })) : (w = 0, e.each(n, function(e, t) {
                    var n = parseInt(t.size);
                    n >= 0 && w >= 0 ? w += n : w = "unknown"
                }), c.push(f.replace(p, i.kind).replace(d, i.files)), c.push(f.replace(p, i.size).replace(d, o.formatSize(w))));
                h = h.replace("{title}", x).replace("{content}", c.join("")), b = o.dialog(h, v), b.attr("id", y), E && e("<img/>").load(function() {
                    b.find(".elfinder-cwd-icon").css("background", 'url("' + E + '") center center no-repeat')
                }).attr("src", E), m.length && o.request({
                    data: {
                        cmd: "size",
                        targets: m
                    },
                    ...
                    g(t >= 0 ? o.formatSize(t) : i.unknown)
                })
            }
                    ...
                    i = function() {
                        var i = {
                            ...
                            s = {
                                ...
                                destroyOnClose: !0,
                                close: function() {
                                    delete t.dialog, r.state() == "pending" && r.reject()
                                },
                                buttons: {}
                            },
            ...
            this.alwaysEnabled = !0, this._handlers = {
                ...
                while (s--) {
                    ...
                    (u = n.url(o.hash)) || (u = n.options.url, u = u + (u.indexOf("?") === -1 ? "?" : "&") + (n.oldAPI ? "cmd=open&current=" + o.phash : "cmd=file") + "&target=" + o.hash), o.dim ? (a = o.dim.split("x"), f = "width=" + (parseInt(a[0]) + 20) + ",height=" + (parseInt(a[1]) + 20)) : f = "width=" + parseInt(2 * e(window).width() / 3) + ",height=" + parseInt(2 * e(window).height() / 3);
                    var l = window.open("", "new_window", f + ",top=50,left=50,scrollbars=yes,resizable=yes");
                    if (!l) return r.reject("errPopup");
                    var c = document.createElement("form");
                    c.action = n.options.url, c.method = "POST", c.target = "new_window", c.style.display = "none";
                    var h = e.extend({}, n.options.customData, {
                        cmd: "file",
                        target: o.hash
                    });
                    e.each(h, function(e, t) {
                        var n = document.createElement("input");
                        n.name = e, n.value = t, c.appendChild(n)
            ...
            this.resize = "resize." + n.namespace, this.info = e('<div class="elfinder-quicklook-info-wrapper"/>').append(y).append(b), this.preview = e('<div class="elfinder-quicklook-preview ui-helper-clearfix"/>').bind("change", function(e) {
                ...
                var n = t.window,
                    r = t.value,
                    u;
                t.closed() && r && (u = m.find("#" + r.hash)).length && (E.attr("style", ""), o = i, u.trigger("scrolltoview"), n.css(l(u)).show().animate(c(), 550, function() {
            ...
            function(t) {
                ...
                r.bind("update", function(s) {
                    ...
                    e.inArray(o.mime, n) !== -1 && (s.stopImmediatePropagation(), r.one("change", function() {
                        ...
                        t.hideinfo(),
                        doc = e('<iframe class="elfinder-quicklook-preview-html"/>').appendTo(r)[0].contentWindow.document, doc.open(), doc.write(n.content), doc.close()
                    }))
                })
            },
            function(t) {
            ...
            function(t) {
                var n = t.fm,
                    ...
                    i = t.preview,
                    s = !1;
                n.UA.Safari && n.OS == "mac" || n.UA.IE ? s = !0 : e.each(navigator.plugins, function(t, n) {
            ...
            function(t) {
                ...
                e.each(navigator.plugins, function(t, n) {
                    ...
                    var o = s.file,
                        u;
                    o.mime == r && (s.stopImmediatePropagation(), 
                                    t.hideinfo(),
                                    i.append(u = e('<embed class="elfinder-quicklook-preview-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="' +
                                            n.url(o.hash) +
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !0, this.shortcuts = [{
                ...
                if (!t) {
                    ...
                    return r.always(function() {
                        clearTimeout(i), n.trigger("reload")
                    })
                }
            ...
            this.updateOnSelect = !1, this.getstate = function() {
                    ...
                    s = function(t, r) {
                        var s = e('<div class="elfinder-dialog-resize"/>'),
                            ...
                            X = e("<img/>").load(function() {
                                ...
                                U = j * t, z = F * t, N.button("enable"), f.find("input,select").removeAttr("disabled").filter(":text").keydown(function(t) {
                                    var r = t.keyCode,
                                        i;
                                    t.stopPropagation();
                                    if (r >= 37 && r <= 40 || r == e.ui.keyCode.BACKSPACE || r == e.ui.keyCode.DELETE || r == 65 && (t.ctrlKey || t.metaKey) || r == 27) return;
                                    r == 9 && (i = e(this).parent()[t.shiftKey ? "prev" : "next"](".elfinder-resize-row").children(":text"), i.length ? i.focus() : e(this).parent().parent().find(":text:" + (t.shiftKey ? "last" : "first")).focus());
                                    if (r == 13) {
                                        n.confirm({
                                    ...
                                    r >= 48 && r <= 57 || r >= 96 && r <= 105 || t.preventDefault()
                            ...
                            Y = {
                                update: function() {
                                    k.val(Math.round(X.width() / B)), L.val(Math.round(X.height() / B))
                                },
                                updateView: function(e, t) {
                                    e > q || t > R ? e / q > t / R ? (B = q / e, X.width(q).height(Math.ceil(t * B))) : (B = R / t, X.height(R).width(Math.ceil(e * B))) : X.width(e).height(t), B = X.width() / e, S.text("1 : " + (1 / B).toFixed(2)), Y.updateHandle()
                                },
                                ...
                                fixWidth: function() {
                                    var e, t;
                                    I && (t = L.val(), t = Math.round(t * H), Y.updateView(e, t), k.val(e))
                                },
                                fixHeight: function() {
                                    var e, t;
                                    I && (e = k.val(), t = Math.round(e / H), Y.updateView(e, t), L.val(t))
                                }
                            },
                            Z = {
                                update: function() {
                                    M.val(Math.round((p.data("w") || p.width()) / B)), _.val(Math.round((p.data("h") || p.height()) / B)), A.val(Math.round(((p.data("x") || p.offset().left) - J.offset().left) / B)), O.val(Math.round(((p.data("y") || p.offset().top) - J.offset().top) / B))
                                },
                                updateView: function() {
                                    var e = parseInt(A.val()) * B + J.offset().left,
                                        t = parseInt(O.val()) * B + J.offset().top,
                                        n = M.val() * B,
                                        r = _.val() * B;
                                    p.data({
                                        x: e,
                                        ...
                                        w: n,
                                        h: r
                                    }), p.width(Math.round(n)), p.height(Math.round(r)), K.width(p.width()), K.height(p.height()), p.offset({
                                        left: Math.round(e),
                                        top: Math.round(t)
                                    })
                                },
                            ...
                            et = {
                                ...
                                imageBeingRotated: !1,
                                update: function(e, t) {
                                    typeof e == "undefined" && (W = e = parseInt(D.val())), typeof t == "undefined" && (t = !0), !t || n.UA.Opera || n.UA.ltIE8 ? Q.rotate(e) : Q.animate({
                                        rotate: e + "deg"
                                    }), e %= 360, e < 0 && (e += 360), D.val(parseInt(e)), P.slider("value", D.val())
                                },
                                execute: function(e) {
                            ...
                            nt = function(t) {
                                e.fn.draggable && e.fn.resizable && (t ? (p.filter(":ui-resizable").resizable("destroy"), p.filter(":ui-draggable").draggable("destroy"), V.hide()) : (J.width(X.width()).height(X.height()), K.width(X.width()).height(X.height()), p.width(J.width()).height(J.height()).offset(J.offset()).resizable({
                                    containment: V,
                        ...
                        Q.mousedown(et.start),
                            ...
                            n.dialog(s, {
                                ...
                                n.UA.ltIE8 && e(".elfinder-dialog").css("filter", ""),
                ...
                return !r.length || r[0].mime.indexOf("image/") === -1
                       ? i.reject()
                       : (o = "resize-" + n.namespace + "-" + r[0].hash, u = n.getUI().find("#" + o), u.length
        ...
        function(e) {
            ...
            this.shortcuts = [{
                ...
                }), i.state() == "pending" && (s = this.hashes(t), r.confirm({
                    title: n.title,
                    text: "confirmRm",
                    accept: {
                        label: "btnRm",
            ...
            this.options = {
                ...
                t.variants = [], e.each(n.sortRules, function(e, r) {
                    var i = {
                            type: e,
                            order: e == n.sortType ? n.sortOrder == "asc" ? "desc" : "asc" : n.sortOrder
                        },
                        s = e == n.sortType ? i.order == "asc" ? "n" : "s" : "";
                    t.variants.push([i, (s ? '<span class="ui-icon ui-icon-arrowthick-1-' + s + '"></span>' : "") + "&nbsp;" + n.i18n("sort" + e)])
                })
            }), n.bind("open sortchange viewchange", function() {
                var r = null;
                r && clearTimeout(r), r = setTimeout(function() {
                    var r = e(n.cwd).find("div.elfinder-cwd-wrapper-list table");
                    r.length && e.each(n.sortRules, function(i, s) {
                        var o = r.find("thead tr td.elfinder-cwd-view-th-" + i);
                        if (o.length) {
                            var u = i == n.sortType,
                                a = {
                                    type: i,
                                    order: u ? n.sortOrder == "asc" ? "desc" : "asc" : n.sortOrder
                                },
                                f;
                            u && (f = n.sortOrder == "asc" ? "n" : "s", e('<span class="ui-icon ui-icon-triangle-1-' + f + '"/>').css({
                                left: "+center+"
                            }).appendTo(o)), e(o).on("click", function(e) {
                                e.stopPropagation(), t.exec([], a)
                            }).hover(function() {
                ...
                return this.fm.setSort(i.type, i.order, i.stick), e.Deferred().resolve()
            }
