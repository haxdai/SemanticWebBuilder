...
elFinder.prototype._options = {
	...
	contextmenu : {
		// navbarfolder menu
		navbar : ['open', 'download', '|', 'upload', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'rename', '|', 'info', 'chmod'], //'places', , 'netunmount'
		// current directory menu
		cwd    : ['reload', 'back', '|', 'upload', 'mkdir', 'paste', '|', 'sort', '|', 'info'], //, 'mkfile'
		// current directory file menu
		files  : ['getfile', '|', 'download', 'opendir', '|', 'upload', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'rename', '|', 'info', 'chmod'] // ,'open', 'quicklook', 'edit', 'resize', 'archive', 'extract', '|', 'places'
	},
