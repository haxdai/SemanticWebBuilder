...
public class GanttChartTest {
    ...
    @Test
    public void doComponentExport() throws IOException {
        WebSite ws = WebSite.ClassMgr.getWebSite(modelId);

        String destpath1 = SWBPlatform.getContextPath() + "/work/models/"
                + ws.getId()
                + "/ganttChart.jpg";
        System.out.println("<p><img width=\"100%\" heigth=\"100%\" src=\"");
        System.out.println(destpath1);
        System.out.println("\" alt=\"graphics\"/></p>");
