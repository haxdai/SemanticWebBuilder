...
//                        }
                ...
                while(deliverables.hasNext()) {
                    ...
                    //if (deli.isActive()) {
                        ...
                        try {
                            if( deliverable.getPlannedStart()!=null && deliverable.getPlannedEnd()!=null )
                            {
                                ...
                                dataOut.append("{");
                                dataOut.append("  taskName : \"");
                                dataOut.append(deliverable.getDisplayTitle(lang));
                                dataOut.append(paramRequest.getLocaleString("lbl_planned"));
                                dataOut.append("\",\n");
                                dataOut.append("  startDate : new Date(");
                                dataOut.append(deliverable.getPlannedStart().getTime());
                                dataOut.append("),\n");
                                dataOut.append("  endDate : new Date(");
                                dataOut.append(deliverable.getPlannedEnd().getTime());
                                dataOut.append("),\n");
                                dataOut.append("  status : \"#33B5E5\"");
                                dataOut.append("}");
                                countDeliverable++;
                            ...
                            if( deliverable.getActualStart()!=null )
                            {
                                ...
                                dataOut.append("\",\n");
                                dataOut.append("  startDate : new Date(");
                                dataOut.append(deliverable.getActualStart().getTime());
                                dataOut.append("),\n");
                                dataOut.append("  endDate : new Date(");
                                if( deliverable.getActualEnd()!=null ) {
                                    dataOut.append(deliverable.getActualEnd().getTime());
                                }else {
                                    dataOut.append(today.getTime());
                                }
                                dataOut.append("),\n");
                                dataOut.append("  status : ");
                                //En base al status asignar color
                                if(deliverable.getAutoStatus() != null) {
                                    dataOut.append(deliverable.getAutoStatus().getColorHex());
                                }else {
                                    dataOut.append("\"#CCCCCC\"");
                                }
                                dataOut.append("}\n");
