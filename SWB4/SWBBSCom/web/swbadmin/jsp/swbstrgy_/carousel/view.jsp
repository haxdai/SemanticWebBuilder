...
%>
 ...
 <% int j = 0;
        ...
        {
                String title = SWBUtils.TEXT.encodeExtendedCharacters( res.getDisplayTitle(lang)==null?res.getTitle():res.getDisplayTitle(lang) );
                String img = SWBPortal.getWebWorkPath() + res.getWorkPath() + "/" + res.getAttribute("img");
                String desc = SWBUtils.TEXT.encodeExtendedCharacters( res.getDisplayDescription(lang)==null?res.getDescription():res.getDisplayDescription(lang) );
    %>
