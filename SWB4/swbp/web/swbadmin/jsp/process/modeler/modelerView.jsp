...
<body style="margin: 0px;" onload="Modeler.init('modeler', {mode: 'view'}, loadProcess);">
    ...
    <div id="fileBar" class="subbarHidden" style="width: 385px;">
        ...
        <span class="newProcess" onmouseover="ToolBar.overToolBar(true);" onmouseout="ToolBar.outToolBar()" title="<%=paramRequest.getLocaleString("itemNew")%>" onclick="if (confirm('<%=paramRequest.getLocaleString("msgClearCanvas")%>')) {Modeler.clearCanvas();}"></span>
    ...
    <div class="overlay" id="overlayBackground">
        <div class="loadDialog">
            ...
            <span class="loadDialogCloseButton">
                <a href="#" onclick="hideLoadDialog();
                        return false;"><%=paramRequest.getLocaleString("lblClose")%></a>
            </span>
