            ...
            <xsl:if test="root/model">
                <xsl:choose>
                    <xsl:when test="root/@export!='true'">
                        <link href="{root/@contextPath}/swbadmin/jsp/process/modeler/images/modelerFrame.css" rel="stylesheet" type="text/css"></link>
                        <xsl:text disable-output-escaping="yes"><![CDATA[ <script src="]]></xsl:text><xsl:value-of select="root/@contextPath" disable-output-escaping="yes"/><xsl:text disable-output-escaping="yes"><![CDATA[/swbadmin/jsp/process/modeler/toolkit.js"></script>]]></xsl:text>
                        <xsl:text disable-output-escaping="yes"><![CDATA[ <script src="]]></xsl:text><xsl:value-of select="root/@contextPath" disable-output-escaping="yes"/><xsl:text disable-output-escaping="yes"><![CDATA[/swbadmin/jsp/process/modeler/modeler.js"></script>]]></xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <HR></HR>
                            ...
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group swbp-toolbar-model">
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="zoomin();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-search-plus fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="zoomout();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-search-minus fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="resetZoom();return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-desktop fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('left');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-arrow-left fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('down');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-arrow-down fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('up');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-arrow-up fa-lg"></span>]]></xsl:text></a>
                                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('right');return false;"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-arrow-right fa-lg"></span>]]></xsl:text></a>
                                    <xsl:choose>
                                        <xsl:when test="root/@export!='true'">
                                            <a href="#" class="btn btn-default swbp-button-tool" onclick="submit_download_form('png');"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-file-image-o fa-lg"></span>]]></xsl:text></a>
                                            <a href="#" class="btn btn-default swbp-button-tool" onclick="submit_download_form('svg');"><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-file-code-o fa-lg"></span>]]></xsl:text></a>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <a href="rep_files/{root/model/@id}.png" class="btn btn-default swbp-button-tool" ><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-file-image-o fa-lg"></span>]]></xsl:text></a>
                                            <a href="rep_files/{root/model/@id}.svg" class="btn btn-default swbp-button-tool" ><xsl:text disable-output-escaping="yes"><![CDATA[<span class="fa fa-file-code-o fa-lg"></span>]]></xsl:text></a>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </div>
                            </div>  
