...
<xsl:output method="html" encoding="ISO-8859-1" indent="yes" />
    ...
    <xsl:template match="/">
        <xsl:choose>
            <xsl:when test="root/@export='true'"><!--set doctype, head. Open html and body tags on export-->
                <xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;</xsl:text>
                <xsl:text disable-output-escaping="yes">&lt;html lang="es_mx"&gt;</xsl:text>
                <head>
                ...
                <xsl:text disable-output-escaping="yes">&lt;body class="swbp-contenido"&gt;</xsl:text>
            </xsl:when>
        </xsl:choose>
        <xsl:choose>
        ...
        <div class="panel-body swbp-panel-body">
            <xsl:call-template name="processInfo"></xsl:call-template>
        </div>
        <xsl:if test="root/@export='true'"><!--add scripts, close html and body tags on export-->
        ...
        <xsl:if test="root/model"><!-- add model section and diagram -->
            ...
            <div class="btn-toolbar hidden-print" role="toolbar">
                <div class="btn-group swbp-toolbar-model">
                    ...
                    <a href="#" class="btn btn-default swbp-button-tool" onclick="resetZoom();return false;"><span class="fa fa-desktop fa-lg"></span></a>
                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('left');return false;"><span class="fa fa-arrow-left fa-lg"></span></a>
                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('down');return false;"><span class="fa fa-arrow-down fa-lg"></span></a>
                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('up');return false;"><span class="fa fa-arrow-up fa-lg"></span></a>
                    <a href="#" class="btn btn-default swbp-button-tool" onclick="handlePanning('right');return false;"><span class="fa fa-arrow-right fa-lg"></span></a>
                    <xsl:choose>
                        <xsl:when test="root/@export!='true'">
                            <a href="#" class="btn btn-default swbp-button-tool" onclick="submit_download_form('png');"><span class="fa fa-file-image-o fa-lg"></span></a>
                            <a href="#" class="btn btn-default swbp-button-tool" onclick="submit_download_form('svg');"><span class="fa fa-file-code-o fa-lg"></span></a>
                        </xsl:when>
                        <xsl:otherwise>
                            <a href="rep_files/{root/model/@id}.png" class="btn btn-default swbp-button-tool" ><span class="fa fa-file-image-o fa-lg"></span></a>
                            <a href="rep_files/{root/model/@id}.svg" class="btn btn-default swbp-button-tool" ><span class="fa fa-file-code-o fa-lg"></span></a>
                        </xsl:otherwise>
                    </xsl:choose>
                </div>
            </div>
            <xsl:choose>
                <xsl:when test="root/@export='true'"><!--add scripts, close html and body tags on export-->
                     <script src="js/modeler/toolkit.js"></script>
                     <script src="js/modeler/modeler.js"></script>
                </xsl:when>
                <xsl:otherwise>
                     <script src="{root/@contextPath}/swbadmin/jsp/process/modeler/toolkit.js"></script>
                     <script src="{root/@contextPath}/swbadmin/jsp/process/modeler/modeler.js"></script>
                </xsl:otherwise>
             </xsl:choose>
    ...
    <!-- SVG modeler template -->
    <xsl:template name="svgmodeler">
        <!--   must have viewBox  -->
