...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 swbp-breadcrumbs">
 ...
 <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 swbp-raised-button">
      <a href="<%= templatesUrl%>" class="btn btn-block swbp-btn-block" data-toggle="tooltip" data-placement="bottom">
 ...
 <div class="row hidden-margin">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-padding pull-right">
        <a onclick="downloadVersion('<%= SWPDocumentationResource.FORMAT_HTML%>')"
                class="btn btn-default btn-block swbp-btn-inter2 hidden-margin" data-toggle="tooltip">
                <%=paramRequest.getLocaleString("lblVersionDownloadH")%>
        </a>
    </div>
     <%if (showWord) {%>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-padding pull-right">
        <a onclick="downloadVersion('<%= SWPDocumentationResource.FORMAT_WORD%>')"
                class="btn btn-default btn-block swbp-btn-inter2 hidden-margin" data-toggle="tooltip" data-placement="bottom">
            <%=paramRequest.getLocaleString("lblVersionDownloadW")%></a>
    </div>
     <%}%>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-padding pull-right">
        <a href="<%= urlVersion.setParameter("idp", idp)%>" class="btn btn-default btn-block swbp-btn-inter2 hidden-margin" data-toggle="modal" data-target="#modalDialog">
            <%=paramRequest.getLocaleString("lblVersion")%>
        </a>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-padding pull-right">
        <a href="<%=urlAdminVersion%>" class="btn btn-default btn-block swbp-btn-inter2 hidden-margin">
            <%=paramRequest.getLocaleString("lblAdminVersion")%>
        </a>
    </div>
...
<div class="panel panel-default swbp-panel-head">
    ...
    <div id="SWBP-MENU-PROCESO" class="panel-collapse collapse">
                    ...
                    %>
                       <a href="#<%= idDocSectionInstance%>" class="list-group-item" onclick="updateBookmark('<%= idDocSectionInstance%>')"> <%=docSectionInstance.getSecTypeDefinition().getTitle()%></a>
