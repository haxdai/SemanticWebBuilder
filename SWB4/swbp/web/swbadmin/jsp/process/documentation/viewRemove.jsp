...
<div class="modal-dialog">
    <div class="modal-content swbp-modal" id="modalContent">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Eliminar <%= null!= dsi ? dsi.getSecTypeDefinition().getTitle() : "" %></h4>
        </div>
        <form method="POST" id="formRemove" action="<%=urlAction%>">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn pull-right col-lg-3 col-md-3 col-sm-6 col-xs-6"><span class="fa fa-trash-o fa-fw"></span><%=paramRequest.getLocaleString("btnRemove")%></button>
