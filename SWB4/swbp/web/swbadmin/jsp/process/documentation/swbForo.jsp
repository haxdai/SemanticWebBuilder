...
if (action != null && action.equals("viewPost")) {
    ...
    if (isforumAdmin || !onlyAdminCreate) {
        ...
        %>
        <div class="row no-margin swbp-button-ribbon text-right">        
            <a href="<%= urlthread %>" class="btn btn-swbp-action">Agregar tema</a>
        </div>
        <hr>
        <%
    } else {
        ...
        while (itThreads2.hasNext()) {
            ...
            if (forum.getId().equals(base.getId())) {
                ...
                <div class="panel swbp-input-tray">
                    <div class="panel-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                %>
                                <p class="text-right">
                                    <span class="fa fa-bullhorn fa-fw"></span><%=thread.getReplyCount()%>
                    ...
                    <div class="panel-footer">
                        <div class="row no-margin">
                            <a class="btn btn-default col-xs-12" href="<%=url%>" role="button">Ver comentarios</a>
                        </div>
                    </div>
                </div>
            <%
